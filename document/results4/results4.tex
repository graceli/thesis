...
\caption[Spatial probability densities of GlcNAc and GlcNH3+ in the C-terminal groove]{Spatial probability distribution of (A) \glucosamine, and (B) GlcNAc in the binding groove in the C-terminal domain (shown at an occupancy of 0.15).  \textbf{the residues in this groove are ...}}
\label{fig:groove}
\end{figure}
