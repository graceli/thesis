...
This study demonstrates the utility of large-scale MD simulations in predicting carbohydrate-protein binding modes. \textbf{[Explain the success of BF massive sampling]  - On the basis of the weak binding affinities of monosaccharrides,  we were able to achieve statistically significant binding events of mono by performing simulations of many repeats of the same system using conventional MD simulations, which leading to the discovery of binding modes consisting of multiple sugars.}   Furthermore, our study indicates that when combined with a force field that can reproduce sugar-protein interactions with relative accuracy \textbf{Suggests previous failure if so, explain - I think I can resolve this part by saying using a force field which can reproduce binding modes of sugars} (for example, GLYCAM\cite{Kirschner:2008ii}). Force fields for molecular simulations of carbohydrates have been recently reviewed here.\cite{Fadda:2010p5889}  Furthermore, we demonstrated the utility of computing spatial probability binding densities using monosaccharides to map carbohydrate binding sites. A recent study suggests that by building 3D density binding maps of carbohydrates and using this data with additional computational algorithms can increase the accuracy of identifying putative carbohydrate binding sites.\cite{Tsai:2012bj} As part of future work, it may be interesting to employ a similar approach to investigate the binding of oligosaccharides to PgaB.  
