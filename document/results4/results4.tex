...
Both sugar molecules adopt similar binding modes involving a combination of hydrogen bonds between the hydroxyl groups of the sugar ring and charged side chains and nonpolar stacking of aromatic moieties.
...
\textbf{As depicted in Figure~\ref{fig:glucosamine_binding_modes_c_term}, glucosamine molecules form nonpolar contacts and hydrogen bonds with the side chains of polar (i.e. GLN) and acidic residues (i.e. ASP and GLU) in both the N-terminal and C-terminal domain of the protein.} 
