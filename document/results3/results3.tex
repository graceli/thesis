...
\textbf{Small molecules are promising candidates for the treatment of AD. A whole bunch of them have been found thus far, and among them are osmolytes.}

Osmolytes are organic molecules that increases protein stability by driving the folding equilibria of proteins into its folded states. Examples include TMAO, glycerol.  Denaturing cosolvents include urea and GdmCl. Osmolytes are thought to affect protein structure by interacting non-specifically with the protein. The molecule mechanism by which osmolytes such as glycerol stabilize proteins is still currently not known.  However, it has been proposed that they may stabilize the protein native state through being preferentially excluded from the peptide backbone.\cite{Bolen:2001im} In recent years, osmolytes have been found to affect amyloid formation\cite{Sukenik:2012dv,Sukenik:2011p8778}:
TMAO,\cite{Seeliger:2013cj}betaine,\cite{Natalello:2009fn} glucose,\cite{Fung:2005p2008} trehalose\cite{Nayak:2009fr} and glycerol\cite{Sukenik:2011p8778} \textbf{there are more} all have been found to modulate amyloid formation and peptide aggregation.\cite{Liu:2005km,Sukenik:2011p8778,Fung:2005p2008} In particular, glycerol is able to slow the kinetics of fibrillation (I don't think this is correct -- check this again).\cite{Yang:1999ws}This paper did a study on myo-inositol, but from a fast scan I wasn't able to figure out what their conclusions for myo- and other polyols are.\cite{Macchi:2012ci}
...
In our previous study, we examined the sequence-independent binding mechanism of inositol with model peptides alanine dipeptide, and the $\beta$-sheet-forming peptide, (GA)$_4$. Weak and stereochemistry independent binding of inositol with the peptidic backbone was found, with binding constants in the range of 0.1 - 1 M. In a further study, we performed MD simulations to examine the binding mechanism of inositol with monomers and aggregates of A$\beta$42. In that study, our results indicated that inositol preferentially binds to the surface of $\beta$-sheet oligomers, but only weak to those of disordered or monomeric forms of \abeta (16-22). Furthermore, inositol was found to adopt cooperative, high avidity binding modes with the beta-oligomer at higher concentrations (KD values were commensurate with \emph{in vitro} concentration of inhibition), suggesting that inositol may disrupt amyloid fibrillation by coating surfaces of beta-sheet oligomers of Abeta.
