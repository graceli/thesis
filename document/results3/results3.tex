...
GROMACS analysis tools g\_rmsd and g\_rmsf were used to calculate the root mean square deviation (RMSD) in the fibril backbone and root mean squared fluctuation (RMSF), respectively.  Spatial probability density of bound solutes were computed using the volmap tool in Visual Molecular Dynamics software package (VMD).

Nonpolar contacts between inositol and fibril were defined by a carbon to carbon cutoff of 0.X nm. The DSSP hydrogen bonding criteria was used to determine the existence of a hydrogen bond.  Secondary structure analysis was performed using the DSSP algorithm by employing the GROMACS tool, do\_dssp. Interchain hydrogen bonds were computed for each adjacent pairs of strands in the fibril using the GROMACS analysis tool g\_hbond using a hydrogen bonding criteria with acceptor-donor heavy atoms with distance less than 0.35 nm and hydrogen-donor-acceptor angle of less than 30 degrees (CHECK THIS).
...
Furthermore, the ligands examined in our study were found to differ in their binding modes (quantitatively). In particular, scyllo-inositol has the highest percentage of molecules bound exclusively via hydrogen bonding.  Moreover,  scyllo-inositol molecules bind by forming nonpolar and hydrogen bonds in equal fractions (Figure~\ref{fig:pie charts with intersection data}). By contrast, a higher fraction of chiro, glucose and glycerol molecules was found to bind by forming nonpolar rather than hydrogen bonding contacts. The fraction of molecules bound by nonpolar contacts increased concomitantly with an increase in hydrogen bonds for chiro-inositol (lowest), glucose and glycerol (highest).  \textbf{[Elaborate -- what are the implications of this finding?  Are there current papers which suggests this?  In my inos2 paper, I mentioned this and RP mentioned that this is really what is coming out of this study. Maybe discuss this in more detail than what was covered in inos2 ... ].}  Consistent with our previous results obtained for the protofibril of KLVFFAE, scyllo-inositol forms more nonpolar contacts than chiro-inositol and glucose, molecules that do not arrest A$\beta$42 inhibition. We previously mentioned that scyllo binds more specifically, our results here suggest that scyllo-, out of all the other solutes, binds most specifically to the CHC (in the region consisting of residues FAE) of Abeta.  However, although other solutes possess binding in this same region, they exhibit nonspecific binding to $\beta$2 face and other parts of the fibril.

% Our results suggest that possessing an ability to form both hydrogen bonds and nonpolar contacts favorably may be an important property of small-molecule inhibitors of amyloid fibrillation.
In our study with A$\beta$(16-22), our results have indicated that the balance of nonpolar and hydrogen bonding interactions is important in inositol binding to monomer and aggregates of the peptide.  Here our results indicate that the ability of scyllo-inositol may lie in it's favorably to form hydrogen bonds. \textbf{What I don't really know -- isn't hydrophobic more important? Every other study emphasized this ... how would I argue that hydrogen bonding is more important?} \textbf{Figure: The nonpolar and polar binding modes for each ligand (that is the pie charts in the KLVFFAE study).}
...
Our study is consistent with recent findings from a MD simulation study on the binding modes of amyloid imaging agents.\cite{recent paper sent to me by regis}

\textbf{Emphasize and mention how the results of this study is consistent with results from KLVFFAE study presented in Chapter 2.}
We previously hypothesized that small-molecules that possess planar nonpolar faces with multiple hydroxyl groups in equatorial positions around the ring confer binding specificity to small molecules for the amyloidogenic core of A? and thus are key features for their activity.  This study confirms this hypothesis in that scyllo-inositol targets the amyloidgenic core with the most specificity.  

% \textbf{What about carbohydrate binding?} --- I don't think I'll need to mention this for now.
