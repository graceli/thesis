...
Upon further investigation with peptides and aggregates of A$\beta$(16-22), inositol was found to adopt cooperative, high avidity binding modes with $\beta$-oligomers characterized by binding constants that are commensurate with \emph{in vitro} inhibitory concentrations.\cite{REF}  Taken together, results from our previous studies indicate that inositol may disrupt amyloid fibrillation by binding to $\beta$-sheet oligomers of A$\beta$.
...
The protofibril presents two chemically different $\beta$-sheet faces. The $\beta$1 face contains residues in the central hydrophobic core of A$\beta$, LVFFA and possesses a negative-charged region formed by a row of solvent-exposed Glu22. In contrast, the $\beta$2 face presents a predominantly hydrophobic surface containing the residues IIGLMVGGVVIA (Figure~\ref{fig:protofibril_cartoon}E).  Scyllo-, chiro-inositol and glucose molecules all bound to the surface of the protofibril (Figure~\ref{fig:spatial_binding}) and were found to partitioned to four main binding sites on the protofibril: (1) $\beta$1 face, (2) $\beta$2 face, (3) edges, and (4) a channel-like cavity formed between the two $\beta$-sheets (Figure~\ref{fig:protofibril_cartoon}).  \textbf{These binding modes of each ligand in these binding sites and their implications for amyloid inhibition are discussed below.}
...
\textit{Scyllo}-inositol predominantly bound to the $\beta$1 face rather than the $\beta$2 face (Figure~\ref{fig:spatial_binding}A). By contrast, however, both \textit{chiro}-inositol and glucose possessed significantly less density on the $\beta$1 face, and instead were bound predominantly to the $\beta$2 face.  
Binding contact maps indicate that binding to the $\beta$1 face is localized to residues Phe20 and Glu22 (Figure~\ref{fig:binding_map}).  As shown in Figure~\ref{fig:detailed_binding_modes}, all three molecules adopt binding modes to the $\beta$1 face via a combination of forming hydrogen bonding to Glu22 and nonpolar contacts with Phe20. 
...
A second location with significant binding density are the grooves located at the edges of the $\beta$-strands of the protofibril. Scyllo-inositol displayed localized binding (Figure~\ref{fig:spatial_binding}, \ref{fig:binding_map}),  whereas both chiro-inositol and glucose bound non-specifically to residues along the entire edge. 
...
The protofibril exhibits a intersheet channel-like cavity surrounded by residues Asp, Lsy, Ile and Leu in the vicinity. This cavity is formed by residues Leu19, Gly18, Ile17, Ile16, Ala15, Gly14, Lys13, Asn12, Ser11, Gly10, Val9, Asp8, which together adopts a turn conformation (Figure~\ref{fig:protofibril_cartoon}).  Of these residues, the side chains of only the residues Asp23, Lys28, Ile32, and Leu34 are pointing towards the inside of the cavity.  Significant binding densities inside this cavity were found for chiro-inositol, glucose, and glycerol, but not for scyllo-inositol (Figure~\ref{fig:spatial_binding}).
% Does not happen with glycerol - completely nonspecific. Scyllo only specific to FAE region.
Both chiro-inositol and glucose molecules bound on the inside of the channel by forming linearly-hydrogen-bonded chains (Figure~\ref{fig:detailed_binding_modes}) that simultaneously formed hydrogen bonds and nonpolar contacts with side chains of residues inside the channel.  Although chiro-inositol and glucose  penetrated this cavity, scyllo-inositol was found to be mostly trapped near its entrance (Figure~\ref{fig:spatial_binding},\ref{fig:detailed_binding_modes}).
...
We speculate that these binding modes are unlikely to lead to amyloid inhibition as these binding sites are not located at area where fibril growth may occur.  \textbf{These binding modes further highlights how the stereochemistry of small molecules can modulate their binding with amyloid fibrils.}
...
In addition to partitioning to different binding sites, ligand binding modes and propensities were also modulated by their stereochemistry. In particular, scyllo-inositol has the highest percentage of molecules bound exclusively via hydrogen bonding.  Furthermore, bound scyllo-inositol molecules form nonpolar and hydrogen bonds in equal fractions (Figure~\ref{fig:binding_sdf_pie_chart}). By contrast, a higher fraction of chiro-inositol, glucose and glycerol molecules was found to bind by forming nonpolar contacts. Furthermore, the fraction of molecules bound by nonpolar contacts increased concomitantly with a decrease in the fraction bound by hydrogen bonds for the ligands in the following order: scyllo- (lowest), chiro-inositol, glucose and glycerol (highest) (Figure~\ref{fig:spatial_binding}). \textbf{Planar with all equatorial hydroxyl groups was most conducive to hydrogen bonding.  The loss of planar nonpolar faces reduced the hydrogen-bonded-only population by X\%. However, a  partial nonpolar faces and having one less hydroxyl led to a Y\% reduction of hydrogen-bonded-only for glucose from chiro-inositol.  As expected, glycerol, which lacks a carbon ring and has only three hydroxyl groups, was the least likely to interact with the fibril by forming only hydrogen bonds, and was most likely to interact via forming non-specific nonpolar contacts.}

Corroborating the results of our previous study,\cite{Li:2013fo} our results here suggest that possessing the ability to form both hydrogen bonds and nonpolar contacts equally favorably may be an important property of small molecules (to target the CHC) and therefore, ultimately, for the inhibition of amyloid formation.
