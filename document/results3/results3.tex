...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=6in]{face_binding.pdf}
  \caption[Detailed binding modes of scyllo-inositol, chiro-inositol, and glucose to the face of the protofibril]{Binding to the faces}
  \label{fig:spatial_face_binding}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=6in]{channel_binding.pdf}
  \caption[Detailed binding modes of scyllo-inositol, chiro-inositol, and glucose to the channel-like groove]{Binding in the tunnel}
  \label{fig:spatial_channel_binding}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=6in]{clustered_binding.pdf}
