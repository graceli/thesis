...
Here, we compare the binding of glucose and glycerol, osmolytes which do not inhibit amyloid aggregation at sub-osmolar concentration (in the milimolar range or less), with inositol stereoisomers, \textit{scyllo}- and \textit{chiro}-inositol. The results in this study elucidates the structure-activity relationship of inositol in the inhibition of A$\beta$ amyloid formation, and sheds light on the role of stereochemistry of small molecules inhibitors in general.
...
In total, a set of ten 0.250 $\mu$s simulations of the protofibril of \abetafortytwo\ were performed,  successively, in pure water and in the presence of \textit{scyllo}-inositol, \textit{chiro}-inositol, glycerol and glucose. The ligands were present at either a ligand:peptide molar ratio of  15:5 or 64:5, yielding a total sampling time of 12.5 $\mu$s. 
...
\begin{figure}[htbp]
  ...
  \caption[Ligands]{Molecular structures of (A) glycerol, (B) glucose, (C) \textit{chiro}-inositol and (D) \textit{scyllo}-inositol}
  \label{fig:ligands}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[RMSD and RMSF vs. time]{Fibril structure dynamics in pure water (A) and (C), and in the presence of \textit{scyllo}-inositol (B) and (D).}
...
\begin{figure}[htbp]
  ...
  \caption[Spatial probability distribution of bound solutes]{Comparisons of the spatial binding probability densities and binding modes for (A) \textit{scyllo}-inositol, (B) \textit{chiro}-inositol, (C) glycerol and (D) glucose.}
  \label{fig:spatial_binding}
\end{figure}

A second location with significant binding density are the grooves located at the edges which runs parallel to the $\beta$-strands in the protofibril. Likewise, \textit{scyllo}-inositol displayed a narrower and more localized densities than those of (Figure~\ref{fig:spatial_binding}, \ref{fig:binding_map}) \textit{chiro}-inositol.  Instead, \textit{chiro}-inositol bound non-specifically to residues along the entire edge.  By contrast to the inositol stereoisomers, glucose did not bind to the edges significantly. We speculate that binding at the edges may slow down fibril elongation, but is unlikely to lead to the arrest the growth of a protofibril into amyloid fibrils.
...
Furthermore, the protofibril exhibits a intersheet channel-like cavity formed by residues Asp8, Val9, Gly10, Ser11, Asn12, Lys13, Gly14, Ala15, Ile16, Ile17, Gly18, and Leu19, which together adopts a turn conformation (Figure~\ref{fig:protofibril_cartoon}).  Of these residues, only the side chains of Asp23, Lys28, Ile32, and Leu34 line the inside of the cavity.  \textit{Chiro}-inositol, glucose, and glycerol, but not for \textit{scyllo}-inositol possessed significant binding densities here (Figure~\ref{fig:spatial_binding}).
...
The spatial binding probability distribution, depicted in Figure~\ref{fig:spatial_binding}, suggests that \textit{scyllo}-inositol has the highest preference for the face of the protofibril containing the residues found in the central hydrophobic core (CHC) of A$\beta$, LVFFAE, particularly to the residues F-A-E. By contrast, inactive molecules, \textit{chiro}-inositol and glucose were both found to predominantly partition to the $\beta$2 face taking part in nonspecific binding. In our previous study, we demonstrated that \textit{scyllo}-inositol displays higher binding specificity to phenylalanine: \textit{scyllo}-, but not \textit{chiro}-inositol, adopts a face-to-face binding mode with phenylalanine.\cite{Li:2013fo} By contrast, due to stereochemistry differences, \textit{chiro}-inositol and glucose molecules do not possess such a binding mode. Consistent with this result, both \textit{chiro}-inositol and glucose displayed less binding specific for the CHC and were predominantly bound by forming nonspecific nonpolar contacts.
