...
Multiple studies have probed the aggregation properties of both \abetaforty\ and \abetafortytwo. Fibril models of the \abetaforty\ peptide derived from solid-state NMR (SSNMR) indicate that protofilaments of \abetaforty\ contain 2 to 3 layers.\cite{Wu:2010p3553,Tycko:2010iz} By contrast, less is known about the fibril structure of \abetafortytwo. A SSNMR model of the core of the fibril of \abetafortytwo\ was recently proposed by L\"uhrs et al.\cite{Luhrs:2005p4900} In that model, the cross-$\beta$ core of the fibrll consisted of residues 17 to 42 with the residues 1 to 16 in the N-terminus of the peptide unstructured in the fibril.\cite{Ahmed:2010p5694}
...
We successively performed simulations of the protofibril of A$\beta$42 in the presence of \textit{scyllo}-inositol, \textit{chiro}-inositol, glucose and glycerol (Figure~\ref{fig:ligands}) at molar ratios of 15:5 and 64:5. In addition, simulations of the protofibril in pure water were also carried out. Because the results were independent of molar ratio, in the sections below, we comparatively examine the binding of the ligands (Figure~\ref{fig:ligands}) in the context of the results from the higher molar ratio.
...
Our previous study on the binding mechanism of inositol with the protofibril of A$\beta$(16-22)\cite{Li:2013fo} suggested that the ability of inositol to bind in clusters is a mechanism by which to increase the local concentration of bound ligands at the surface. Our result here is consistent with that study and we speculate that clustered binding modes of small molecules also play a role in the amyloid inhibition of full-length A$\beta$.  In support of our results, amyloid dye molecules in simulations\cite{Shea:2012eh} and Congo red in experiments,\cite{Stopa:2003wy} were also observed to adopt similar binding modes.
...
Experimental evidence suggests that the residues 17 to 21 (LVFFA) forming the central hydrophobic core of full-length A$\beta$ peptide are responsible for the initiation of A$\beta$ aggregation and $\beta$-sheet formation.\cite{deGroot:2006p4453}  Our study in chapter 3 indicated that the likely mode of action of inositol is to bind to surfaces of $\beta$-sheets of A$\beta$(16-22).\cite{Li:2013fo} 
