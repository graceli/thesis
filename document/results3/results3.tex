...
Importantly, \emph{scyllo}-inositol was demonstrated to prevent and reverse AD-like symptoms in a transgenic mouse model of AD.\cite{McLaurin:2006eb} Phase I and II of clinical trials for \emph{scyllo}-inositol (ELN0005) in North America has been completed.\cite{Salloway:2011ima,Ma:2012jk} These clinical trials have demonstrated that inositol possesses positive CNS bioavailability and favorable \emph{in vivo} toxicity profile. Although clinical trials have successfully demonstrated the safety and tolerance profile of inositol, further chemical modification is likely required to improve the efficacy of inositol.  Understanding the molecular basis of the effect of inositol stereoisomers on A$\beta$42 will aid in the rational drug design of more efficacious derivatives inositol.
...
However, the molecular basis of the stereospecific effect of \emph{scyllo}-inositol and its stereoisomers on A$\beta$42 amyloid inhibition is not understood.
...
In two previous studies (Chapters 3 and 4), we have successively examined the binding mechanism of scyllo- and chiro-inositol with peptide and aggregate states of model amyloid-forming peptides\cite{Li:2012bx} and A$\beta$(16-22).\cite{Li:2013fo}  Weak and stereochemistry independent binding of inositol with the peptidic backbone was found, with binding constants in the range of 0.1 - 1 M, indicating that inositol is unlikely to inhibit amyloid formation by binding the peptidic backbone alone (see Chapter 2).\cite{Li:2012bx} In that study, inositol was found to bind to the surface of $\beta$-sheet oligomers with the highest affinity, but was only weakly to those of disordered or monomeric forms, suggesting that $\beta$-sheet oligomers is the most likely binding partner of inositol.

Upon further investigation with peptides and aggregates of A$\beta$(16-22), inositol was found to adopt cooperative, high avidity binding modes with $\beta$-oligomers characterized by binding constants that are commensurate with \emph{in vitro} inhibitory concentrations.\cite{Li:2013fo}  Taken together, results from our previous studies indicate that inositol may disrupt amyloid fibrillation by binding to $\beta$-sheet oligomers of A$\beta$.
...
Here in this study, we examine the binding of inositol stereoisomers, scyllo- and chiro-inositol, and osmolytes glucose and glycerol with the SSNMR model of the protofibril of full-length \abetafortytwo. Glucose and glycerol are organic osmolytes that can stabilize the folded structures of globular proteins. Osmolytes are thought to stabilize the folded state via the preferential exclusion mechanism.\cite{Bolen:2001im}  In recent years, these osmolytes have been found to modulate amyloid formation.\cite{Sukenik:2012dv,Sukenik:2011p8778} TMAO,\cite{Seeliger:2013cj} betaine,\cite{Natalello:2009p2237} glucose,\cite{Fung:2005p2008} trehalose\cite{Nayak:2009fr} and glycerol\cite{Sukenik:2011p8778} been found to modulate amyloid formation and peptide aggregation.\cite{Liu:2005km,Sukenik:2011p8778,Fung:2005p2008} \textbf{Inhibit? or promote formation?}  The molecular basis of cosolute binding to A$\beta$42 fibrils have not been previously examined. Here, we compare the binding of glucose and glycerol, osmolytes which do not inhibit amyloid aggregation at sub-osmolar concentration (milimolar range), with that of scyllo- and chiro-inositol. The results in this study elucidates the structure-activity relationship of inositol in the inhibition of A$\beta$ amyloid formation, and sheds light on the role of stereochemistry of small molecules inhibitors in general.
...
The GROMACS analysis utilites g\_rmsd and g\_rmsf were used to calculate the root mean square deviation and root mean squared fluctuation of the fibril backbone, respectively.  Spatial probability density of bound ligands was computed using the VolMap analysis tool implemented in the Visual Molecular Dynamics (VMD) software package.\cite{Humphrey:1996to}

The number of hydrogen bonds between each pair of peptides in the protofibril were computed using g\_hbond.  The following geometry criteria used to determine a hydrogen bond:  (1) the distance between acceptor (A) and donor (D) heavy atoms is less than 0.35 nm, and (2) the angle formed by H-D-A is less than 30$\degreesymb$. Nonpolar contacts between inositol and fibril were defined by a carbon to carbon cutoff of 0.X nm. The DSSP algorithm was used to perform the secondary structure analysis of the protofibril.\cite{Kabsch:1983bp}

\section{Results and Discussion}

We successively performed simulations of Abeta in the presence of  inositol stereoisomers, \textit{scyllo}-inositol and \textit{chiro}-inositol, and osmolytes glucose and glycerol (Figure~\ref{fig:ligands}) at molar ratios of 15:5 and 64:5.  Because the results were independent of molar ratio, in the sections below, we comparatively examine the binding of the ligands (Figure~\ref{fig:ligands}) in the context of the results from the higher molar ratio.
...
A second location with significant binding density are the grooves located at the edges which runs parallel to the $\beta$-strands in the protofibril. Likewise, scyllo-inositol displayed a narrower and more localized densities than those of (Figure~\ref{fig:spatial_binding}, \ref{fig:binding_map}) chiro-inositol.  Instead, chiro-inositol bound non-specifically to residues along the entire edge.  By contrast to the inositol stereoisomers, glucose did not bind to the edges significantly.
...
Furthermore, the protofibril exhibits a intersheet channel-like cavity formed by residues Leu19, Gly18, Ile17, Ile16, Ala15, Gly14, Lys13, Asn12, Ser11, Gly10, Val9, Asp8, which together adopts a turn conformation (Figure~\ref{fig:protofibril_cartoon}).  Of these residues, only the side chains of Asp23, Lys28, Ile32, and Leu34 are lining the inside of the cavity.  Chiro-inositol, glucose, and glycerol, but not for scyllo-inositol possessed significant binding densities here (Figure~\ref{fig:spatial_binding}).
% Does not happen with glycerol - completely nonspecific. Scyllo only specific to FAE region.
Both chiro-inositol and glucose molecules bound on the inside by forming linearly-hydrogen-bonded chains (Figure~\ref{fig:detailed_binding_modes}) that simultaneously formed hydrogen bonds and nonpolar contacts with side chains of residues inside the channel.  Although chiro-inositol and glucose  penetrated this cavity, scyllo-inositol instead was mostly trapped near its entrances (Figures~\ref{fig:spatial_binding}, \ref{fig:detailed_binding_modes}).
...
In support of our results, several previous simulation studies utilizing the same model of the A$\beta$42 protofibril have observed similar binding modes for amyloid dye molecules (ThT and PiB),\cite{Wu:2011fd} and a polyphenol morin.\cite{Lemkul:2010p6251}
% TODO AND what???
...
\textbf{We speculate that these binding modes are unlikely to lead to amyloid inhibition as these binding sites are not located at area where fibril growth may occur.  However, differential binding in this cavity exhibited by the inositol stereosiomers and glucose further emphasizes how stereochemistry of small molecules can modulate their binding to amyloid morphologies.}
...
In addition to partitioning to different binding sites, both ligand binding modes and propensities also were modulated by ligand stereochemistry. In particular, scyllo-inositol has the highest percentage of molecules bound exclusively via hydrogen bonding ($\sim$25\%).  Furthermore, only scyllo-inositol molecules bound by forming nonpolar contacts (24\%) and hydrogen bonds (26\%) approximately in equal proportion (Figure~\ref{fig:binding_sdf_pie_chart}). By contrast, a higher fraction of chiro-inositol, glucose and glycerol molecules than scyllo-inositol were bound by forming nonpolar contacts (Figure~\ref{fig:binding_sdf_pie_chart}). Furthermore, the fraction of molecules bound by exclusively nonpolar contacts increased concomitantly with a decrease in the fraction bound exclusively by hydrogen bonds for the ligands in the following order: scyllo- (26\%, 22\%), chiro-inositol (33\%, 13\%), glucose (37\%, 9\%), and glycerol (50\%, 11\%) (Figure~\ref{fig:spatial_binding}). \textbf{The stereochemistry of \textit{Scyllo}-inositol, planar hydrophobic faces and all equatorial hydroxyl groups, was the most conducive to hydrogen bonding.  The loss of planar nonpolar faces in \textit{chiro}-inositol reduced the hydrogen-bonded-only population by $\sim$9\%. However, possessing only partial nonpolar faces and one less hydroxyl group led to a 13\% reduction in the population that was bound by hydrogen bonds only for glucose from \textit{scyllo}-inositol.  Glycerol, which lacks a carbon ring and has the least number of hydroxyl groups, was most likely to interact via forming non-specific nonpolar contacts.}

Corroborating the results of our previous study,\cite{Li:2013fo} our results here in this study suggest that possessing the ability to form both hydrogen bonds and nonpolar contacts equally favorably may be an important property of small molecules (to target the CHC) and therefore, ultimately, for the inhibition of amyloid formation.
...
Experimental evidence suggests that KLVFFAE (residues 16 to 22 of the full-length peptide) is responsible for fibril formation.\cite{deGroot:2006p4453} The residues LVFFA, called the central hydrophobic core (CHC) of A$\beta$, is thought to be responsible for the initiation of A$\beta$ aggregation and $\beta$-sheet formation. Our previous study indicated that the likely mode of action of inositol is to binding to surfaces of $\beta$-sheets, specifically of those involving the KLVFFAE segment.\cite{Li:2013fo} This binding mode is modulated by the stereochemistry of the small molecule and physicochemical properties of the fibril surface that is available for binding. For example, a simulation study examining the binding of morin, a predominantly hydrophobic compound, found that morin did not significantly interact with residues in the CHC, but rather bound \textbf{to residues at the C-terminal end of the protofibril}.

On the basis of our results above, we hypothesize that the CHC, particularly the residues Phe20 and Glu21, is a critical binding site of \textit{scyllo}-inositol for preventing the formation of A$\beta$42 fibrils. In corroboration with our results, a recent simulation study by Convertino et al.\cite{Convertino:2011epa} found that anthraquinone was likely to act by binding to LVFFA region. Our results are consistent with these studies and supports the hypothesis that selectively targeting the CHC segment of the A$\beta$ may be a viable approach for the inhibition of A$\beta$ fibrillation.
...
In a previous study (see Chapter 3), we investigated the binding mechanism of inositol stereoisomers with protofibrillar oligomers of A$\beta$(16-22).\cite{Li:2013fo} Unlike A$\beta$42, the protofibril of A$\beta$(16-22) presents two chemically identical faces consisting of the same polar, charged and hydrophobic grooves. For this reason, in that study, \textit{scyllo}- and \textit{chiro}-inositol were found to bind in similar binding sites protofibril of A$\beta$(16-22). \textbf{Although binding modes of a small molecule may remain consistent across relatively different models, its binding site and binding specificity may be modulated by the fibril surface properties.} As a consequence, comparatively examining the binding modes of several small molecules with differing activities is crucial for determining the molecular mechanism of a small molecule amyloid inhibitor.

Our results indicate that model amyloidogenic peptides are useful for eliminating the large number of possible mechanisms of binding and elucidating the residue-specific binding modes of a small molecule. However, because the activity of small-molecule inhibitors are sequence-specific, it is necessary to  to examining their binding with different morphologies of the full-length A$\beta$.
...
% The central hydrophobic cluster of amyloid-Î² (residues 17â€“21 LVFFA) has been particularly implicated in amyloid fibril formation (19). Tjernberg et al. (20) found that the fragment QKLVFF binds to amyloid Î² to prevent amyloidogenesis, whereas follow-up studies investigated the short peptides, LVFFA (21) and LPFFD (22), and showed that they are also inhibitors and that the fragment KLVFFAE forms well ordered fibrils. 
%
%KLVFFA binds to ABeta42 -- do they where they bind?
%Tjernberg, L. O., Naslund, J., Lindqvist, F., Iohansson, J., Karlstrom, A. R., Thyberg, J., Terenius, L., and Nordstedt, C. (1996) Arrest of í¯¿í¶ˆ-amyloid fibril formation by a pentapeptide ligand, J. Biol. Chem. 271, 8545-8548.
%
%
%Second, AÎ²(16-22) peptide, which includes the central HP core, CHC (LVFFA), is recognized as being essential for AÎ² fibrillation (27,28) and also forms amyloid fibrils with antiparallel Î²-strands in isolation (29). Third, the KLVFF motif is a primary target in the search for aggregation inhibitors for AD therapeutics (30,31).
%28. Nilsberth C., Westlind-Danielsson A., Lannfelt L. The â€˜Arcticâ€™ APP mutation (E693G) causes Alzheimer's disease by enhanced AÎ² protofibril formation. Nat. Neurosci. 2001;4:887â€“893. [PubMed]
%29. Balbach J.J., Ishii Y., Tycko R. Amyloid fibril formation by A Î² 16-22, a seven-residue fragment of the Alzheimer's Î²-amyloid peptide, and structural characterization by solid state NMR. Biochemistry. 2000;39:13748â€“13759. [PubMed]
%30. Lowe T.L., Strzelec A., Murphy R.M. Structure-function relationships for inhibitors of Î²-amyloid toxicity containing the recognition sequence KLVFF. Biochemistry. 2001;40:7882â€“7889. [PubMed]
%31. Lashuel H.A., Hartley D.M., Callaway D.J. New class of inhibitors of amyloid-Î² fibril formation. Implications for the mechanism of pathogenesis in Alzheimer's disease. J. Biol. Chem. 2002;277:42881â€“42890. [PubMed]
% \section*{Figures}
...
%% Try to put nonpolar and hydrogen bonding for each ligand on separate panels. When put together itÕs a little difficult to emphasize the differences
