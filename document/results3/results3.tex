...
The protofibril presents two chemically different $\beta$-sheet faces: the $\beta$1 face which contains residues in the central hydrophobic core of A$\beta$, LVFFA, and the $\beta$2 face which has a predominantly hydrophobic surface containing the residues IIGLMVGGVVIA (Figure~\ref{protofibril_dynamics}E).  Scyllo-, chiro-inositol and glucose molecules all bound to the surface of the protofibril (Figure~\ref{fig:spatial_binding}). However,  they each partitioned to different binding sites on the protofibrillar surface. Depicted in Figure~\ref{fig:spatial_binding}, \textit{scyllo}-Inositol predominantly bound to the $\beta$1 face rather than the $\beta$2 face. By contrast, both \textit{chiro}-inositol and glucose possessed little or no density on the $\beta$1 face, but instead possess significant binding densities on the $\beta$2 face.  In contrast to inositol stereoisomers and glucose, glycerol did not possess significant binding density on either faces (Figure~\ref{fig:spatial_binding}C). Because glycerol does not bind the solvent-exposed surface of the protofibril, in the sections below the term ligands will be used to collectively refer to scyllo-, chiro-inositol and glucose for purposes of clarity.
...
Furthermore, the ligands displayed binding densities in the grooves located at the edges which run parallel to the $\beta$-strands of the protofibril (Figure~\ref{fig:spatial_binding}).  \textbf{The ligand-protofibril contact maps shown in Figure~\ref{fig:} indicate that ...[ elaborate - which residues? Look at the contact map ].}
...
The protofibril exhibits a channel-like cavity surrounded by residues XX ... .  In this cavity,  a significant binding density was found for chiro-inositol, glucose, and glycerol, but not for scyllo-inositol (Figure~\ref{fig:spatial_binding}).  Both chiro-inositol and glucose molecules were found to bind to the inside of the channel by forming linearly-hydrogen-bonded chains, while simultaneously forming hydrogen bonds and nonpolar contacts with the side chains of residues (Figure~\ref{fig:detailed_binding_modes}). 

Although chiro-inositol and glucose were able to penetrate into the intersheet tunnel, scyllo-inositol was found to be mostly trapped near the channel entrance (Figure~\ref{fig:spatial_binding},\ref{fig:detailed_binding_modes}).
...
have observed similar binding modes for amyloid dye molecules (ThT and PiB),\cite{Shea} and a polyphenol morin.\cite{Lemkul et al.} in the same region.
% TODO AND what???
...
We speculate that these binding modes are unlikely to lead to amyloid inhibition as these binding sites are not located at area where fibril growth may occur.
...
Ligand binding modes and binding propensity was modulated by their stereochemistry. In particular, scyllo-inositol has the highest percentage of molecules bound exclusively via hydrogen bonding.  Furthermore, bound scyllo-inositol molecules form nonpolar and hydrogen bonds in equal fractions (Figure~\ref{fig:binding_sdf_pie_chart}). By contrast, a higher fraction of chiro-inositol, glucose and glycerol molecules was found to bind by forming nonpolar contacts instead of hydrogen bonds. 

The fraction of molecules bound by nonpolar contacts increases concomitantly with a decrease in the fraction bound by hydrogen bonds for the solute according to the following order: scyllo- (lowest), chiro-inositol, glucose and glycerol (highest) Figure~\ref{fig:spatial_binding}. Consistent with the results of our previous study on KLVFFAE, our results here suggest that possessing the ability to form both hydrogen bonds and nonpolar contacts equally favorably may be an important property of small molecules (to target the CHC) and therefore, ultimately, for the inhibition of amyloid formation.
...
There are a few reasons. In our previous study, we demonstrated that scyllo-inositol displays higher binding specificity to phenylalanine: scyllo-, but not chiro-inositol, adopts a face-to-face binding mode with phenylalanine. By contrast, due to stereochemistry differences, chiro-inositol and glucose molecules do not possess such a binding mode. In the results of our current study, both chiro and glucose were shown to adopt less specific binding modes, which implies less specific binding. Their binding is less specific to the same region than that of scyllo-inositol.  Taken together, our results indicate that scyllo-inositol displays specificity of binding to the amyloidogenic core of A$\beta$ amyloid. This is consistent with what we found in our KLVFFAE study.

On the basis of our results, we hypothesize that binding to the face of protofibrils containing the residues LVFFAE may be a productive small-molecule binding mode for the inhibition of lateral stacking of fibrils.  The difference in the binding specificity of scyllo- and chiro-inositol towards the KLVFFAE face may explain the activity of scyllo-, but not chiro-inositol, in the inhibition of A$\beta$ amyloid fibrillation.  Because scyllo-inositol has high binding affinity and specificity to the $\beta$1, it may be responsible for preventing the lateral association of fibrillar aggregates, which may ultimately lead to inhibition of amyloid formation.
Without the ability to form stacks, A$\beta$ fibrils are not likely to grow into a fibril as a single layer. % ie. require stacking to grow into the long unbranched morphology seen in EM.
