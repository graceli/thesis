...
Nonpolar contacts between inositol and fibril were defined by a carbon to carbon cutoff of 0.X nm.  Secondary structure analysis was performed using the GROMACS tool do\_dssp, which implements the DSSP algorithm.

The number of hydrogen bonds between each pair of peptides in the protofibril were computed using g\_hbond.  The hydrogen bonding criteria was (1) distance between acceptor and donor heavy atoms less than 0.35 nm, and (2) the angle formed by hydrogen-donor-acceptor is less than 30$\degree$.
