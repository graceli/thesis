...
In this study, we examine the binding mechanism of inositol stereoisomers, scyllo- and chiro-inositol, along with glucose and glycerol, with the SSNMR model of the protofibril of full-length \abeta42.  

Both glucose and glycerol affect fibrillation of A$\beta$42\ at concentrations of more than 1 M. 

\textbf{I think it makes more sense to talk about osmolytes here} 

Organic osmolytes such as glycerol and glucose, are small molecules that stabilize the folded state of proteins. Examples include TMAO, glycerol, and are thought to do so via the preferential exclusion mechanism.\cite{Bolen:2001im}  In recent years, osmolytes that stabilize the folded state of proteins, have been found to modulate amyloid formation\cite{Sukenik:2012dv,Sukenik:2011p8778}. TMAO,\cite{Seeliger:2013cj}betaine,\cite{Natalello:2009fn} glucose,\cite{Fung:2005p2008} trehalose\cite{Nayak:2009fr} and glycerol\cite{Sukenik:2011p8778} been found to modulate amyloid formation and peptide aggregation.\cite{Liu:2005km,Sukenik:2011p8778,Fung:2005p2008} \textbf{Is modulate inhibit? or promote formation?}  The molecular basis of cosolute binding to A$\beta$42 fibrils have not been previously examined. Thus, it is informative to comparatively study the binding of these cosolutes and inositol stereoisomers, a known inhibitor of A$\beta$ amyloid formation.

Missing some connective logic.
...
% \textbf{But so what? There is no logical link presented for this piece of information right now}
...
%\textbf{The rationale of my study:} It has been suggested that several cosolutes do not inhibit amyloid formation. 
...
\textbf{Key result}. Solutes bind to the surfaces to the protofibril. Inositol stereoisomers, glucose and glycerol partition to different binding sites on the protofibrillar surface.  The ligands predominantly bind at the faces and edges of the protofibril. \textbf{Faces}. The protofibril presents two chemically different $\beta$-sheet faces: the $\beta$1 face containing the residues in the central hydrophobic core of \ab\, LVFFA, and a largely hydrophobic $\beta$2 face containing the residues IIGLMVGGVVIA.  \textit{scyllo}-Inositol has the largest binding density on the $\beta$1 face (Figure~\ref{fig:spatial_binding}), whereas \textit{chiro}-inositol, glucose and glycerol possess little or no density on the $\beta$1 face. \textbf{[Incomplete - Discuss binding to the beta2 face]} Unlike inositol, glucose bound predominantly to the $\beta$2 face, but had little density on the $\beta$1 face. In contrast to the binding exhibited by glucose and inositol, glycerol does not possess significant binding density on either faces, suggesting that glycerol does not significantly bind the surface of the protofibril.

\textbf{Binding at the edges} Moreover, significant binding densities for both inositol and glucose was found at edges of the protofibril, parallel to a $\beta$-strand and perpendicular to the long-axis of the fibril.  These binding modes at these edges may serve to prevent strand elongation. [ elaborate - which residues? Look at the contact map.  The SDF indicates that binding to the edges are not even, that is on one side, there is more binding than the other. This is a convergence issue.  May need a section in the discussion discussing the convergence of the results.] 

Furthermore, inositol binds to the part of the edges involving charged termini of the peptides, and to the residues located in the turn region, residing within a tunnel-like region inside the protofibril (Figure~\ref{???}). 
% Binding in the channel
Interestingly, a significant density of binding in the ``tunnel" of \ab42\ was found for chiro-inositol, glucose, and glycerol, but not for scyllo-inositol.  Chiro-inositol and glucose can bind inside of the tunnel by forming linearly-hydrogen bonded chains, while simultaneously forming hydrogen bonded and nonpolar contacts with the protofibril (Figure XXX -- snapshot of chiro and glucose binding). Although, both chiro-inositol and glucose were able to penetrate the intersheet tunnel, scyllo-inositol was found to be trapped near the channel entrance and does not move through the channel (Figure~\ref{fig:show a figure or figure inset focused on this binding mode}).: although scyllo-inositol can intercalate between the sheets near the opening of this tunnel, a significant binding density for scyllo-inositol was not found (Figure~\ref{snapshot of scyllo binding at this region}). We speculate that these binding modes are unlikely to lead to amyloid inhibition as these binding sites are not located at area where fibril growth may occur.

In corroboration with our results, several previous simulation studies of dye molecules ThT and PiB, and the polyphenol molecule morin binding have also observed similar binding modes in the same region. AND what??? REF 
%In corroboration with our results, a MD study by Shea et al. indicated that dye molecules, PiB and ThT,  can penetrate into the same channel for the same protofibrillar model.\cite{Wu:2011fd} (This sentence is better for discussion).
...
% [ Note that I took this sentence from SheaÕs paper. They had intended to say that they saw that CR can bind as dimers and that this observation is not an artifact of smulation but rather observed in other studies as well.  They did not really say thatÕs how it inhibits amyloid formation]
...
%	\begin{itemize}
%		\item From a single spatial distribution for scyllo and chiro, I did not see scyllo go all the way through the â€œchannelâ€, where as chiro does! (RESULT)
...
%			\end{itemize}
%	\end{itemize}
%	\item Sugar binding to the A$\beta$42 fibril -- appears to stabilize? I don't think so â€¦ this isn't true from looking at the data.
%	
...
%The high affinity binding sites shows that É. what was this again?
%
...
% Comparisons to earlier simulation studies of inhibitor binding to A$\beta$42 and A$\beta$40 -- where does this go?
% Binding mechanism of inositol with abeta42. Inositol interestingly also seem to binding similarly to guanidinium ions around a hydrophobic surface. (Personal communication with Shekhar - Said to me during CBP that they see similar results from their guanidinium ion studies ... what does this really mean?) -- I don't see how this idea will fit into the paper
