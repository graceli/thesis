...
\documentclass[12pt,onehalfspaced,normalmargins]{ut-thesis}
% \usepackage{rotating}
...
% Molecular Mechanism of $\beta$-amyloid Inhibition By Inositol

% Thesis global command definitions
\input{my-thesis-commands}
...
% \include{introduction-MD-methods}

% Model peptides
% The conversion of this to the thesis chapter is almost done
