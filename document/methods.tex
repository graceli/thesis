...
The outcome of MD simulations is controlled by a force field.
...
MD is simply an algorithm to simulate motion of a system under the influece of a specific force field by following molecular configurations in time according to Newton's equation of motion. 
...
Simulation systems are usually in the canonical ensemble (NVT) or  isothermo-isobaric (NPT) ensembles. These are statistical-mechanics ensembles used to relate the microscopic arrangements of the system to their thermodynamic properties such as the free energy. NVT is fixed number of particles and fixed volume and temperature.  NPT is fixed number of particles, constant pressure and temperature. This ensemble is the closest to experimental laboratory conditions, and hence simulations are often carried out in this fashion.
