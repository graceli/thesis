...
\end{equation}
where $m_{i}$ is the mass of the atom, $v_{i}$ is the velocity along a single dimension, and $k_{B}$ is the Boltzmann constant. In MD simulations, the temperature of the system is the total kinetic energy of the system normalized by the number of degrees of freedom in the system, $N_{f}$, that is,
\begin{equation}
