...
An empirical force field is applied in MD to approximate atomic interactions in the system, which has many parameters to be determined. One approach to do this is to fit to quantum mechanical calculations.  orce fields are iteratively improved by predicting experimentally observable quantities for small compounds, and adjusting the fit based on comparisons of these computationally predicted quantities with experimental measurements.
