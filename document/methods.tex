...
Because nuclei are much heavier than electrons, they are typical fixed on the time scales of electronic vibration. For this reason, the total energy (or the Hamiltonian, $H$) of a system can be considered to depend only on the electronic motion. As a consequence, the nuclear motion of a system is then governed by a potential energy function under the influence of a single electronic state.
