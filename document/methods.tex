...
Because nuclei are much heavier than electrons, they are practically stationary on the time scales of electronic vibration. 

\textbf{For this reason, the total energy (or Hamiltonian, $H$) of a system can be considered to depend only on the electronic motion. As a consequence, the nuclear motion of a system is then governed by a potential energy function under the influence of a single electronic state. -- unclear, why?}
...
In molecular mechanics, atomic nuclei are treated as point charges, and the motion of their electrons is implicitly accounted for in the PEF.  \textbf{Because electronically excited states are not treated, no chemical reactions (i.e., bond formation) can occur.}
