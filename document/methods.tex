...
As discussed in Chapter 1 \ref{chap:introduction}, hydrogen bonding is an important type of electrostatic interaction and hence their proper representation must be captured by a force field.
Hydrogen bonding interactions are generally account for as a combination of van der Waals and electrostatic interactions.  However, certain force fields (e.g., XXX) employ an explicit term solely for hydrogen bonding.
