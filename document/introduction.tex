...
A puzzling aspect of AD is that in the brain of dementia patients, the plaque load is often not correlated with disease progression and severity. Instead, multiple lines of evidence support that synaptic loss, and the severity of cognitive impairment are correlated with the concentration of soluble \abeta\ oligomers in the brain.\cite{Wang:1999fx,McLean:1999ud,Lue:1999vx} \textbf{For example, oligomers extracted from AD brain potently impair synapse structure and function (5).}\cite{Tam:2012vz} and references therein.  Moreover, injection of forms of Abeta oligomers into the brains of animal models of AD was found to impair learning performance and decrease the number of synapses in animal models.\cite{Lesne:2006gx,Cleary:2005kt,Martins:2007bz,Tam:2012vz} Furthermore, upon the addition of A$\beta$ oligomers (prepared in vitro or extracted from cell cultures), cellullar models of toxicity exhibited characteristic symptoms of neurotoxicity, leading to eventual apoptosis.\cite{Cappai:2007bc,Lambert:1998ve,Walsh:2002p2566,Shankar:2008bg,Walsh:2007fu} Taken together, current experimental evidence indicates that preventing the formation of oligomeric forms of A$\beta$ may be a viable method of treatment for AD.
...
% Are referred to as ``diffuse'' plaques.\cite{Walsh:2007fu} donÕt go into the structure here ... it was covered before...but can mention it as a connection 
