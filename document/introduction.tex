...
% Move this to the AD section?
% The concept of intermediate involvement in AD has been used to explain why amyloid pathology (as defined by Aβ plaque load) is only poorly correlated with clinical AD presentation, while ample evidence argues that Aβ peptide must be critical to AD onset. Intermediate involvement reconciles these two apparently contradicting findings, attributing AD pathology to small Aβ structures rather than to fibril-containing amyloid plaques.
