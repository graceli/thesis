...
\textbf{Studies of dye molecules have provided significant insight into the binding modes of small molecules with amyloid fibrillar aggregates.  The molecular mechanism of ThT binding with fibrils was examined in detail in recent years by a number of biophysical and simulation studies. The application of \textit{in silico} methods and smaller, more experimentally tractable self-assembly model systems have been employed to investigate the atomic details of Congo red (CR) and thioflavin T (ThT) binding. Repetitive.}

MD simulation studies examined the binding of CR with the protofibril of the amyloidogenic fragment GNNQQNY of the yeast prion Sup35,\cite{Wu:2007p361} and most recently with protofibrils of full-length \abeta40.\cite{Shea:2012eh} Both of these studies found that CR molecules bind in the fibrillar grooves, between peptide strands, in parallel to and perpendicular to the long-axis of the fibril, respectively.  In both studies, it was hypothesized that the observed $\beta$-sheet surface binding mode disrupts $\beta$-sheet stacking.   \textbf{A key difference between the two studies was that \abeta40\ has a larger number of binding sites for CR than GNNQQNY, where CR was found to bind at the edge of  \abeta40\ fibrils, thought to block strand-to-sheet extension.}  Moreover, based on these binding modes, a model for explaining the birefringence displayed by A$\beta$ fibrils upon binding CR was proposed.\cite{Shea:2012eh}

To define the minimal requirements for ThT binding, Biancalana et al. designed a set of novel ThT-binding proteins to create a minimalist binding site for ThT that recapitulated all of its fibril binding properties (i.e. fluorescence emission upon binding).\cite{Biancalana:2009p5056} The X-ray crystal structure of the protein containing a high-affinity binding site for ThT showed that the beta-sheet contained adjacent (side-by-side) ladders (\textbf{This needs to be defined}) composed of residues tyrosine (Tyr) and leucine (Leu).\cite{Biancalana:2010p5053} Based on this structure, the authors hypothesized that ThT preferentially binds to aromatic grooves at fibrillar surfaces. A complementary MD simulation study of this model ThT-binding protein was later conducted by Wu et. al. corroborated this hypothesis.\cite{Wu:2009p1954}
...
The molecular details of EGCG binding to A$\beta$ monomers were further examined in a follow-up MD simulation study.\cite{Liu:2011ka} Simulations were initiated using the same monomeric structure as in the previous study by Wang et. al., and \textbf{utilized two ligand concentrations that were shown to have the most effect on EGCG binding}. Using MM-PBSA, a technique that employs an implicit solvent model to estimate binding free energies,\cite{MM-PBSA citation} the authors found that nonpolar interactions rather than hydrogen bonding contributed more to EGCG binding modes.
...
In a follow-up MD study, the same authors investigated the effect of morin binding on the aggregation and conformational equilibria of dimeric oligomers of \abeta42.\cite{Lemkul:2012jn} Morin was not observed to bind directly to the central hydrophobic core of the Abeta peptide (residues 16 to 21), but instead to residues flanking it.  \textbf{Missing several links to this conclusion.} They speculate that the binding of morin to \abeta42\ peptides alters the tertiary interactions formed as the peptides aggregate, thereby preventing \abeta42\ monomers from forming a stable hydrophobic nuclei. \textbf{What is this based on? Is it believable?}
...
\textbf{In each of these studies, replica exchange MD simulations, an enhanced sampling simulation methodology, were conducted to increase the likelihood of NSAID-Abeta binding events}. An implicit solvent model was used in place of explicit solvent representation to reduce the computational time required for their simulations.
...
In each of these studies, a large amount of sampling on the order of tens of microseconds were devoted to understanding of NSAID binding.  However, because of their use of implicit solvation which is known to cause hydrophobic interactions to become more favorable, binding modes determined in their studies may have been artificially biased. \textbf{Nevertheless, the authros derived interesting results which may help further our understanding of small molecule binding...}
