...
In addition to the presence of amyloid plaques, another hallmark lesion found in the brains of patients with AD is neurofibrillary tangles, which are composed of hyperphosphorylated forms of the microtubule-associated protein tau.  Although both plaques and NFTs appear together, it is currently thought that NFTs play a secondary role to \abeta\ in the pathogenesis of AD.  \textbf{Mouse models of tau pathologies do not develop AD, and instead develop tau pathologies.} Multiple lines of evidence supports that \abeta\ production may drive the formation of tau pathologies (formation of NFTs).\cite{Ittner:2010he,Bulic:2010p8317}
