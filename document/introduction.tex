...
\section{Molecular mechanism of action of small-molecule aggregation inhibitors}
...
\subsection{Biophysical study}
% Thioflavin T (ThT)
% Note to self - Not sure if this idea belongs in the review of the small molecules.  

% We use dye molecules to try to understand how binding to amyloid works.  At least we are working something where we know the species of amyloid that it binds to. We can understand how binding works by using a combination of biophysical approaches, and computer simulations.  

% Consider moving this to the section where I talk about MD simulations and combine it with biophysical studies which attempts to elucidate the molecular mechanism of binding ... In any case, I don't feel like there is any computational studies that offer ``decent'' insight into binding to make it a whole section on its own, so perhaps write this section as `` what we currently know about the molecular mechanism of small molecule inhibitor binding'' as ``previous work''.  Also I think talking about binding mechanisms fits better there because I've also introduced ideas of binding equilibria, and pharmacological aspects.  Here I don't have to mention the binding constants, and whether they are in clinical trials etc or where these small molecules come from.
