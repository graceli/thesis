...
Through the routine use of dyes to detect the presence of amyloid, it is common thought that these dye molecules stained amyloid fibrils by binding to them. Through the use of a combination of biophysical approaches, and computer simulations the binding of dye molecules Congo red and Thioflavin T with amyloid fibrils examined in recent years have provided the first clues into how a small molecule may bind amyloid.

\subsubsection{Congo red}
Experimental binding studies where chemical modifications were made to CR suggest that both ionic and hydrophobic interactions may be important for its binding as disruption of either can affect its binding affinity. Biophysical studies of the binding of CR molecules with the amyloid fibril suggest that CR is most likely to be binding along the long-axis of the fibril. % Although CR is typically used to detect the presence of fibrillar aggregates, studies suggest that CR can also interact with monomers of alpha-synuclein, and alpha-helical form of poly-L-lysine.\cite{Maltsev:2012kw}

In 2007, Duan et al.\cite{Wu:2007p361} performed short simulations of the protofibril of the  amyloidogenic fragment GNNQQNY of the yeast prion Sup35, in the presence of two molecules of Congo red (CR).  CR was found to adopt two main binding modes: in the grooves of the fibril, parallel to the long-axis, or between two peptide strands, perpendicular to the long-axis. Based on contact binding analysis, hydrophobic interactions was suggested to be the main driving force of CR binding. Based on their results, it was speculated that CR may block fibril growth along the $\beta$-sheet stacking direction by binding in grooves at the surface of the amyloid protofibril. 
...
In 2011, to gain insight into the optical and inhibitory properties of CR with Abeta, a study by Shea et. al. was one of the first studies to examined the binding of CR molecules with protofibrils of full-length \abeta40.REF In comparisons to previous studies of CR with GNNQQNY, where only two major binding sites were identified in that study, seven binding sites for CR on the protofibril of \abeta40\ was identified (Fig. 4, A–G), and were classified into three main binding modes: groove binding, ?-strand binding, and edge binding. The authors conclude that binding on the ?-sheet surface may play a role in interrupting sheet-to-sheet stacking, whereas edge binding, may play a role in blocking strand-to-sheet extension. 
Furthermore, based on these observed binding modes, the authors proposed a model for explaining the birefringence observed under polarizing light when CRs are bound to fibrils. 
http://www.sciencedirect.com.myaccess.library.utoronto.ca/science/article/pii/S0006349512007801

\subsubsection{ThT} 
Due to the ubiquitous use of ThT as a amyloid fibril probe, the molecular mechanism of ThT binding was probed in recent years by several simulation and biophysical studies. ThT is soluble in water and have \KD\ in the low \micromolar\ range: 0.033 to 23 micro molar.\cite{Groenning:2009p2723} Studies have suggested that ThT binds at the surface of the fibril, parallel to its long-axis, and may depend on the physiochemical properties of the amyloid fibril.\cite{Wu:2009p1954,Biancalana:2010p5053,Wu:2011fd,Mao:2011ic} More than one binding site with similar affinities for ThT may be present on fibrils. Moreover, ThT binding is not limited to fibrils, and was found to bind in hydrophobic pockets of human serum albumin, a globular protein, with comparable affinity to many drug-like molecules.\cite{Groenning:2007p3436,Groenning:2007eo}

In a series of studies, Shea et al examined ThT binding to A?9–40profibril (22) as well as to other fragments ( 49 and 50).  These studies revealed that the main binding mode of ThT is located in the grooves, suggesting that CR and ThT share the same primary recognition motif. 
...
Although CR and ThT may share similar binding recognition motifs, that is, groove binding, due to differences in their molecular structure, and varying surface properties of fibrils, they are not likely to share similar binding sites on the surfaces of Abeta fibril. Furthermore, unlike CR, ThT has not be reported to affect amyloid formation. In corroboration with experimental results, simulation studies suggested that CR molecules can bind at fibrillar edges, whereas this binding mode was not observed in binding simulations of ThT.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
