...
The application of both \textit{in silico} methods and experimentally tractable model self-assembly systems have provided significant insight into the binding modes of small molecules with amyloid fibrillar aggregates. MD simulation studies examined the binding of CR with the protofibril of the amyloidogenic fragment GNNQQNY of the yeast prion Sup35,\cite{Wu:2007p361} and most recently with protofibrils of full-length \abeta40.\cite{Shea:2012eh} Although  \abeta40\ was found to contain more binding sites for CR than GNNQQNY, CR shared similar binding modes with both protofibrils: CR molecules were bound in the fibrillar grooves, between peptide strands, in parallel to and perpendicular to the long-axis of the fibril, respectively.  Taken together, the results of these studies led to the authors to hypothesize that the observed $\beta$-sheet surface binding mode disrupts $\beta$-sheet stacking, whereas edge binding (found exclusively with \abeta40\ fibrils), block strand-to-sheet extension.  Moreover, based on these binding modes, a model for explaining the birefringence displayed by A$\beta$ fibrils upon binding CR was proposed.\cite{Shea:2012eh}

\textbf{To define the minimal requirements for ThT binding, Biancalana et al. designed a set of novel ThT-binding proteins to create a minimalist binding site for ThT that recapitulated all of its fibril binding properties (i.e. fluorescence emission upon binding).\cite{Biancalana:2009p5056} The X-ray crystal structure of the protein containing a high-affinity binding site for ThT showed that the beta-sheet contained repetitive grooves formed by tyrosine (Tyr) and leucine (Leu) which are arranged side-by-side at the sheet surface (called ``ladders'').\cite{Biancalana:2010p5053} Based on this structure, the authors hypothesized that ThT preferentially binds to aromatic grooves at fibrillar surfaces. A complementary MD simulation study of this model ThT-binding protein was later conducted by Wu et. al. corroborated this hypothesis.\cite{Wu:2009p1954}}
% and a crystal structure of a model ThT-binding protein.\cite{Wu:2009p1954}

In several MD simulation studies, Wu et. al. examined the binding of ThT and its analogs to protofibrils of the A$\beta$ peptide fragment A$\beta$(16-22)\cite{Wu:2008ds} and the protofibril of the full-length A$\beta$40.\cite{Wu:2011fd}   These studies revealed that similar to the binding modes of CR, ThT was bound to several binding sites located on the surface of fibrils.  Furthermore, although CR and ThT may share similar binding site motifs, these simulations support that it is unlikely that they share similar binding sites because of differences in their chemical structure and surface properties of fibrils.

The above studies, when taken together, suggest a consensus for the molecular mechanism of dye binding to amyloid fibrils: dyes bind in the grooves at the surface of amyloid fibrils, and that their physical properties are related to these binding modes. However, it is still not understood why CR, but not ThT binding, leads to fibril inhibition. Further investigation of differences in their binding mechanism will be required.
...
Using a combination of isothermal titration calorimetry (ITC), NMR, and MD simulations, the interaction of EGCG molecules with monomeric \abeta42\ as modulated by temperature, pH, salt concentration, and ligand:protein molar ratio was investigated by Wang et. al.\cite{Wang:2010p5887} Simulations of A$\beta$ peptides were initiated from an alpha-helical conformation, and were performed in the presence of EGCG at increasing molar ratios.  Results of this study indicated that both hydrogen bonding and hydrophobic (aromatic) interactions are important for binding of EGCG, and that the balance of these interactions is modulated by ligand:protein stoichiometry.

The molecular details of EGCG binding to A$\beta$ monomers were further examined in a follow-up MD simulation study.\cite{Liu:2011ka} Simulations of a monomer of $\beta$ with the same initial structure as the previous study\cite{Wang:2010p5887} were performed in the presence of EGCG at two different concentrations. Using MM-PBSA, a technique that employs continuum solvent models to estimate binding free energies,\cite{MM-PBSA citation} the authors found that nonpolar interactions rather than hydrogen bonding contributed more to EGCG binding modes.
% (\textbf{did they provide a number ... was this based on energetic analysis?}).
Furthermore, based on secondary structure analysis of the peptide conformations, EGCG, when bound, was found to prevent $\beta$-strand formation at the ligand:peptide molar ratio of 10:1.

Binding of morin, another polyphenol molecule with the ability to inhibit amyloid formation by Abeta and IAPP peptides,\cite{Noor:2012fc} was examined with protofibrils of \abeta42\ by Lemkul et. al.\cite{Lemkul:2010bf} Based on contact analysis and snapshots from their simulations, morin was found binding at the edges of the protofibril and partially penetrate into the hydrophobic interior of the protofibril.  Furthermore, morin molecules was observed to hydrogen-bond to and intercalate between a pair of residues which formed salt-bridges within the fibril in a significant fraction of their simulations.

In a follow-up MD study, the same authors investigated the effect of morin binding on the aggregation and conformational equilibria of dimeric oligomers of \abeta42.\cite{Lemkul:2012jn} Morin was not observed to significantly bind to the central hydrophobic core of the Abeta peptide (residues 16 to 21), but instead to residues flanking it.  Although the presence of morin did not affect the secondary structure of the peptide monomer and dimer, but that their binding impeded the formation of intra- and inter-peptide hydrophobic contacts.   On the basis of these results, the authors propose that morin prevents fibril formation of \abeta42\ by disrupting the formation of an initial stable hydrophobic nuclei.

The non-steroidal anti-inflammatory drugs (NSAIDs), ibuprofen and naproxen, which are typically taken for pain relief,\cite{NSAID and pain relief} were also found to inhibit Abeta fibrils in vitro.\cite{lift some refs from Klimov}  In a series of MD simulation studies, the binding mechanism of ibuprofen\cite{Raman:2009jn} and naproxen\cite{Kim:2011fn} was examined with oligomers and protofibrils of \abeta40\ were investigated by Klimov et. al.
In each of these studies, replica exchange MD simulations, an enhanced sampling simulation methodology, were conducted to increase the likelihood of NSAID-Abeta binding events. An implicit solvent model was used in place of explicit solvent representation to reduce the computational time required for their simulations.

In their ibuprofen study, the authors found that ibuprofen preferentially binds with the protofibril rather than monomeric of \abeta40.\cite{Raman:2009jn} Ibuprofen were predominantly bound to hydrophobic grooves at the edges of protofibrils. The authors proposed that this protofibrillar binding mode of NSAIDs may inhibit fibril formation by blocking fibril elongation.  Furthermore, a comparative study of naproxen and ibuprofen were carried out to identify the molecular basis of naproxen's stronger in vitro binding affinity.\cite{Takeda:2010gx} Although naproxen and ibuprofen share similar spatial binding sites on the fibril, naproxen was found to have higher binding energy than ibuprofen, because of its preference for self-interaction. The authors proposed that naproxen may interfere with A$\beta$ oligomer formation by intercalating between associating monomeric peptides.\cite{Kim:2011fn} 
...
In summary, simulation studies suggest that both hydrophobic and hydrogen bonding interactions are involved in the binding mechanism of known in vitro small molecule inhibitors. Several mechanistic hypotheses for the molecular mechanism of amyloid inhibition by small molecules have been put forth. Based on MD simulations,  it has been hypothesized that binding to surfaces of $\beta$-sheet aggregates may prevent fibril formation. [refs]  Furthermore, in vitro, small molecules inhibitors are known to interact with multiple species along the amyloid formation pathway.  For this reason,  simulation studies were conducted to examine their interaction with monomers and non-fibrillar amyloid aggregates. These studies suggest that by interacting with these amyloidogenic aggregates,  small molecules may prevent early oligomer formation by displacing the beta-sheet-forming propensity of amyloidogenic peptides, or by preventing  peptide association. [Refs]

Despite the continued increase in computational power, modern MD simulations of disordered proteins and peptides remain computationally challenging.  For this reason, the conclusions drawn from these simulations may suffer from systematic or statistical sampling errors that are difficult to identify. Thus far, studies of small molecule binding lack statistically significant number of binding events. due to limitations in the simulation methodology and the sampling time of these studies. Hence, important quantity such as dissociation constants (\KD) were not determined.  Without an estimate for the \KD, it would be difficult to assess the relevance of the binding sites identified the simulations with regards to amyloid inhibition because direct comparisons with \emph{in vitro} measurements cannot be made.
...
\textbf{An implicit solvation model may be used in place of explicit solvent representation in order to reduce computational complexity of the simulations. Some of the studies above have utilized this method to examine small molecule binding mechanisms. However, one key disadvantage of implicit solvation is that the reproduction of solvent effects is much less accurate. Because solvent effects are an important contributing factor to the free energy of ligand binding,  poor reproduction of these effects can lead to less accurate binding modes.}
% Nevertheless, the authros derived interesting results which may help further our understanding of small molecule binding...

Few studies conducted currently are systematic comparative studies of monomers, disordered oligomers and protofibrillar aggregates. Because it is often not known which amyloidogenic species these small molecules may act on, the lack of adequate comparisons may leave a study susceptible to biased conclusions. Moreover, experimental studies have suggested that the activity of these small molecules may be modulated by their concentration and molar ratio. For example, the self-aggregation of small-molecule binders such as EGCG, CR, and ThT have been observed in both experimental and simulation studies. However,  the molecular basis of the dependence of the mechanism of inhibition of small molecules on these experimental variables have not been addressed by most studies.
