...
Depending on the sugar, the sugar binding sites adopt differing geometries. There are general types of binding sites: a deep binding site with high binding affinity, or a shallow groove with low binding affinities. 
The most frequently occurring residues in these sugar binding sites are aromatic (Trp, Tyr and Phe) and charged residues (Glu and Asp).
