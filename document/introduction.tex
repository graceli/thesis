...
Amyloid deposits of different proteins have several physical properties in common. Amyloid fibrils exihibit specific optical behavior upon binding certain dye molecules. After staining with Congo Red, amyloids exhibit bright green birefringence under polarized light. 

Furthermore, despite having dramatically different sequences, amyloid fibrils formed from different polypeptides adopt a similar structure: The first structural studies of fibrils using X-ray fiber diffraction showed that a \crossb\ is characterized by a 4.8\angstrom\ interpeptide, and 10\angstrom\ intersheet spacing. (Figure~\ref{fig:fibril_diffraction})
