...
% Organization of the peptide backbone into beta-sheets.
The ubiquitous presence of a \crossb\ structure supports that the organization of the peptidic backbone, common to all proteins, in to \bsheets\ is a major determinant of the fibrillar structure. 
% Stacking -- but this could be just experimental limitations
% Moreover, several of the proposed structures, despite very different sequences of their component polypeptides, suggest that the core region is composed of two to four sheets that interact closely with each other.
