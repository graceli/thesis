...
Polyphenols is a class of molecules found both naturally in plants. They can also be made synthetically. 
In particular, the most common subgroup of phenolic compounds are called flavonoids (Figure~\ref{fig:polyphenols}), which are known for their anti-oxidant properties.  Experimental studies of several flavonoids have suggested that they may modulate amyloid aggregation. Furthermore, because of their favorable toxicity profiles and high IC50 of inhibition, they have emerged as promising therapeutic candidates for Alzheimer's Disease and related neurodegenerative diseases. % They have a high EC50 -- review this

-epigallocatechin-3-gallate (EGCG) is the major polyphenolic component of green tea. In vitro cell culture experiments have shown that micromolar concentrations of EGCG are protective against Abeta-induced cell death. [Bastianetto et al., 2006; Kim et al., 2007; Levites et al., 2003]. 

Their molecular mechanism of action is currently not yet. [ Do they have all similar mechanism of action? What are their advantage and disadvantages as a therapeutic for AD? ]
