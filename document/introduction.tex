...
% SSNMR
Advances in solid-state NMR (SSNMR) and X-ray crystallography in the last decade have elucidated the molecular details of amyloid fibrils. One of the first SSNMR model of an amyloid fibril was that of \abeta40, a peptide implicated in Alzheimer's Disease.\cite{Petkova:2006gx}
...
%24. Sinha S, et al. (2012) Comparison of three amyloid assembly inhibitors: The sugar scyllo-inositol, the polyphenol epigallocatechin gallate, and the molecular tweezer CLR01. ACS Chem Neurosci 3(6):451‚Äì458.
...
\begin{equation}
	\Delta G = -RT\ln K_{d},
\end{equation}
where $R$=1.9858775×10$^{−3}$ kcal$\cdot$K$^{-1}\cdot$mol$^{-1}$ is the gas constant, and $T$ is the temperature in the SI unit of Kelvin.
...
A hydrogen bond is formed from electrostatic interactions arising between two dipoles: an acceptor and a donor.  The acceptor group is comprised of an electronegative heavy atom (e.g. F, Cl, O), with exposed lone pairs of electrons, and the donor group is an electropositive atom. Furthermore, unlike dispersion forces, hydrogen bonds are directional, where the orientation of the hydrogen atom on the donor group affects the free energy of the interaction. Hydrogen bonds formed between peptide backbones involve N-H and O=C groups as the donor and acceptors, respectively. In intermolecular hydrogens formed in water, the O-H group acts as both the donor and acceptor group.
...
In proteins, intra- and intermolecular hydrogen bonds can be formed between the peptidic backbone, and polar or charged amino acid side chains of polypeptides. Specific hydrogen bonding patterns define protein secondary structure (helices and \bsheets),\cite{Pauling:1951th,Pauling:1950wp} and impart stability to the tertiary structures that are formed by the association of secondary structure elements.\cite{Myers:1996ey} For example, hydrogen bonding patterns determine the arrangement of peptide strands into either parallel or anti-parallel $\beta$-sheets.\cite{Watson:1953ug} In addition, peptides with their peptidic backbones hydrogen-bonded to each other to form in-register $\beta$-sheets are at the core of the \crossbs\ of amyloid fibrils (see Section \ref{sec:amyloid}). 
...
Atomic features of protein-carbohydrate interactions are generally characterized by the formation of hydrogen bonds and nonpolar interactions with aromatic moieties.\cite{Vyas:1991p6498} Often, a delicate balance between hydrophobic and hydrogen bonding interactions is required for in protein-carbohydrate binding, where a slight change in the stereochemistry of the carbohydrate substrate can alter its binding specificity.\cite{Munske:1984ug} % Not sure if this reference is entirely appropriate here.
...
%(Figure~\ref{fig:rational_drug_design})
...
% [Should these be concluding paragraphs or opening? I feel like they read as concluding because now that you�ve gone through the studies.  But from another angle, it would make reading the detailed reviews easier for readers because now they are guided rather than getting lost in the details of the studies. Furthermore, it is easier to justify not providing an exhaustive review. This is quite similar to how David structured his review section in his thesis.]
Simulation studies suggest that both hydrophobic and hydrogen bonding interactions are involved in the binding mechanism of known in vitro small molecule inhibitors. In summary, several mechanistic hypotheses have been put forth based on results from MD simulations. Many of them hypothesize that binding to surfaces of $\beta$-sheet aggregates may be involved in the molecular mechanism of amyloid inhibition by small molecules.

Provide studies of fibril binding by dyes ... and other SMIs.

Small molecules inhibitors may have the ability to interact with different species,  simulation studies were conducted to examine their binding with non-fibrillar oligomer species. MD simulations of these systems have suggested that small molecule inhibitors, by binding to these amyloidogenic aggregates, may displace the beta-sheet-forming propensity of these peptides. 

Provide studies of fibril binding by [insert random SMIs here].

Thus far, studies of these dye molecules have provided significant insight into the binding modes of small molecules with amyloid fibrillar aggregates. The application of in silico techniques and smaller, more experimentally tractable self-assembly model systems have been employed to investigate the atomic details of Congo red (CR) and thioflavin T (ThT) binding.
MD simulation studies examined the binding of CR with the protofibril of the amyloidogenic fragment GNNQQNYof the yeast prion Sup35,\cite{Wu:2007p361} and most recently with protofibrils of full-length \abeta40.\cite{Shea:2012eh} From these studies, CR molecules were found to adopt two main binding modes: in the grooves of the fibril, parallel to the long-axis, or between two peptide strands, perpendicular to the long-axis. Based on these observed binding modes, it was hypothesized that $\beta$-sheet surface binding disrupts $\beta$-sheet stacking, whereas fibril edge binding blocks strand-to-sheet extension.  Moreover, based on these binding modes, a model for explaining the birefringence displayed by Abeta fibrils upon binding CR was proposed.\cite{Shea:2012eh}

The molecular mechanism of ThT binding with fibrils was examined in detail in recent years by a number of biophysical and simulation studies.  In contrast to CR, ThT binding has not been observed to affect amyloid aggregation.  ThT displays \KD's  in the low \micromolar\ range, with values ranging from 0.033 to 23 \micromolar\ reported in literature.\cite{Groenning:2009p2723} The binding affinity of ThT is modulated by physiochemical surface properties of the amyloid fibril: ThT does not appreciably bind fibrils with highly-charged residues such as those of poly-Lysine peptides.\cite{Sabate:2008hb,Khurana:2003dk} 

To define the minimal requirements for ThT binding, Biancalana et al. designed a set of novel ThT-binding proteins to create a minimalist ThT binding site which recapitulated all of its fibril binding properties (i.e. emission of fluorescence upon binding).\cite{Biancalana:2009p5056} The X-ray crystal structure of the protein with a high-affinity binding site for ThT showed that the binding site contained adjacent (side-by-side) ladders (This needs to be defined) formed from Tyr and Leu,\cite{Biancalana:2010p5053} which led the authors to hypothesized that ThT preferentially bind to aromatic grooves at fibrillar surfaces. A complementary MD simulation study was later conducted and the results of which corroborated this hypothesis.\cite{Wu:2009p1954}

In several MD simulation studies, Wu et. al. examined ThT binding to protofibrils of the A$\beta$ peptide fragment Abeta(16-22), full-length A$\beta$40,\cite{Wu:2011fd} and a crystal structure of a model ThT-binding protein.\cite{Wu:2009p1954}  These studies revealed that similar to the binding modes of CR, ThT was bound to several binding sites located at the grooves on the surface of fibrils.  Furthermore, although CR and ThT may share similar binding site motifs, their simulations support that it is unlikely that they share similar binding sites because of differences in their chemical structure and surface properties of fibrils.

Taken together, the above studies suggest a consensus for the molecular mechanism of dye binding to amyloid fibrils, where dye molecules are likely to bind in the grooves at the surface of amyloid fibrils. However, it is still not understood why CR, but not ThT binding, leads to fibril inhibition. Further investigation of differences in their binding mechanism will be required.
...
\textbf{Polyphenols}. In a MD and NMR study, the binding of EGCG with monomeric of \abeta42\ were examined by Wang et. al.\cite{Wang:2010p5887} Using ITC and NMR, the authors examined the influences of temperature, pH, salt concentration, and ligand:protein molar ratios on A$\beta$-EGCG interactions. MD simulations of the A$\beta$ monomer were performed in the presence of EGCG at increasing molar ratios.  Results of their study suggested that both hydrogen bonding and hydrophobic (aromatic) interactions are important for binding of EGCG, and are modulated by experimental solution conditions and ligand:protein stoichiometry.

The molecular details of EGCG binding to Abeta monomers were more extensively examined in a follow-up MD simulation study at two ligand concentrations.\cite{Liu:2011ka} Using MM-PBSA, a technique used to estimate binding free energies employing an implicit solvation model, the authors found that nonpolar interactions contributed more than hydrogen bonding to the binding modes of EGCG. Furthermore, based on analysis of the secondary structure of the peptides, EGCG, when bound, was found to prevent beta-strand formation at the ligand:peptide molar ratio of 10:1.

Morin is a polyphenol molecule with the ability to inhibit amyloid formation by Abeta and IAPP peptides.\cite{Noor:2012fc} Binding of morin molecules was first examined with the protofibril form of \abeta42\ was examined by Lemkul et. al.\cite{Lemkul:2010bf} Based on snapshots from their simulation trajectories, Morin was observed to hydrogen-bond with .... and intercalate between residues which form salt-bridges within the fibril.

In a follow-up study, an MD study of dimers of \abeta42\ peptides with morin was performed by the same authors.\cite{Lemkul:2012jn} Morin was not observed to bind directly to the central hydrophobic core of the Abeta peptide (residues 16 to 21), but instead to residues flanking it.  
They hypothesized that the binding of morin to \abeta42\ peptides alters the tertiary interactions formed as the peptides aggregate, thereby preventing \abeta42\ monomers from forming a stable hydrophobic nuclei.

\textbf{NSAIDs}. The non-steroidal anti-inflammatory drugs (NSAIDs), ibuprofen and naproxen, which are typically taken for pain relief, were also found to inhibit Abeta amyloid formation in vitro.\cite{lift some refs from Klimov}  In a series of MD simulation studies, their binding mechanism with amyloid oligomers of \abeta40\ were investigated by Klimov et. al.\cite{Raman:2009jn,Takeda:2010gx,Kim:2011fn}
In the first study, simulations of ibuprofen molecules were conducted with a tetramer unit of the \abeta40\ fibril derived from an SSNMR study.\cite{Raman:2009jn}  \textbf{Replica exchange MD simulations were conducted to enhance the sampling of binding events of ligands with the protofibril}. However, an implicit solvent model was used in place of explicit solvent representation to reduce the computational time required for their simulations. Ibuprofen were predominantly bound to hydrophobic grooves at the edges of protofibrils.   Based on this result, the authors hypothesized that this protofibrillar binding mode of NSAIDs prevents fibril formation.
A comparative study of naproxen and ibuprofen binding using similar simulation conditions and methodology were carried out to identify the molecular basis of naproxen's stronger inhibition effects.\cite{Takeda:2010gx} The authors found that naproxen ... [Insert results here] Based on the results of that study, simulations of dimers of Abeta40 were conducted with naproxen to further examine its binding modes with disordered forms of amyloid aggregates.\cite{Kim:2011fn}
[Insert description of results here]
A total of XX seconds were devoted to studies of NSAID binding.  Although the total sampling time is long by modern standards, the author's use of implicit solvation pose several issues. Because the lack of explicit water in these simulations, the binding mode of ligands may be biased because of hydrophobic interactions may be favored. 
...
Despite the continued increase in computational power, modern MD simulations of disordered proteins and peptides remain computationally challenging.  For this reason, the conclusions drawn from these simulations may suffer from systematic or statistical sampling errors that are difficult to identify. Thus far, studies of small molecule binding lack statistically significant number of binding events. due to limitations in the simulation methodology and the sampling time of these studies. Hence, dissociation constants (Kd) were not determined.  Without this quantity, comparisons with in vitro data cannot be made, making it more difficult to assess the relevance of the binding sites identified the simulations with regards to amyloid inhibition.
...
Moreover, experimental studies have suggested that the activity of these small molecules may be modulated by their concentration and molar ratio. For example, the self-aggregation of small-molecule binders such as EGCG, CR, and ThT have been observed in both experimental and simulation studies. However,  the molecular basis of the dependence of the mechanism of inhibition of small molecules on these experimental variables have not been thoroughly characterized.

% Many studies do not address reversible binding.
Amyloidogenic monomers and oligomers are highly dynamic species, and may require a large amount of computational sampling in order to obtain statistical convergence in their secondary structures in order to determine the effect of presence of small molecules on their conformational equilibria. Hence, several MD studies have utilized smaller fragments of the A$\beta$ peptide.\cite{Convertino:2011epa,Convertino:2009ce,Chebaro:2012ba}

Although, a few recent studies have employed MD simulations in combination with enhanced sampling methods to probe binding of small molecules with full-length peptide monomer of A$\beta$, existing studies have drawn conclusions based on data from only a few short simulations likely to contain conformationally unconverged ensembles of peptide in both the presence and absence of ligands.  The lack of convergence could mislead researchers to draw conclusions based on differences due to systematic and statistical biases. 
...
Because my results from Chapters 3 and 4 indicated that inositol acts on protofibrils of A$\beta$ rather than monomeric or non-beta-sheet oligomeric states, in Chapter 5 we proceeded to examined the binding of inositol to the protofibril of full-length A$\beta$42.
