...
One out of eight people aged 65 or older has Alzheimer?s Disease (AD).\cite{citron}  With the increasing longevity of our population, AD is approaching epidemic proportions with no cure or preventative therapy available.  A pathological hallmark of Alzheimer?s is the extracellular deposition of amyloid in the brain.  These fibrillar deposits (plaques) are formed from the self-aggregation of the ?-amyloid (A?) peptide, a 38 to 42 residue protein that is produced normally as part of the cellular metabolism.  Similarly, amyloid composed of other peptides or proteins are also found in other neurodegenerative diseases such as Parkinson?s, Huntington?s, and prion-related diseases.

One therapeutic approach is the development of small-molecule inhibitors of A? aggregation. Recently, scyllo-inositol has emerged as a promising compound for the treatment of AD, which has currently completed phase two of clinical trials. It is one of eight stereoisomers of inositol found in nature and exhibits stereochemistry-dependent inhibition of A? fibrillation.\cite{mclaurin:2000} Scyllo-inositol is effective at reversing the established disease state as well as preventing the onset of AD-like symptoms in a transgenic mouse model of AD, whereas chiro-inositol is inactive.\cite{mclaurin:2006}  Currently, scyllo-inositol has completed phase two of clinical trials, which evaluates its dose-related safety and efficacy in participants with mild to moderate AD.
...
At present, experimental approaches lack the ability to determine the precise mechanistic mode(s) of action of inositol because the molecular structures of various intermediates in the amyloid aggregation pathway are not known. 
...
As a first step to investigate the stereochemistry-dependent effect on amyloidogenic peptide aggregation and morphology, I examined the effect of backbone interactions in polypeptide self-aggregation by systematically characterizing the binding equilibria of inositol with model peptides, alanine dipeptide (ADP), an amyloid-forming peptide (Gly-Ala)$_4$ in Chapter 3. 

In Chapter 4, I continued my investigation of the molecular basis of the activity of inositol by characterizing the binding mechanism of inositol with the peptide and aggregates of the amyloid-forming peptide fragment of A$\beta$(16-22) or KLVFFAE.  A$\beta$(16-22) is a short fibril-forming fragment which is thought to be central in the initiation of amyloid formation in the full-length A$\beta$ peptide. In this study, it was uncovered that stereochemistry-dependent binding modes exist with the aromatic sidechain of phenylalanine. Furthermore, rather than adopting one specific binding mode or binding site, surface binding to $\beta$-sheet containing aggregates plays a central role in the activity of inositol.  Taken together, the results presented in these chapters suggest that the activity of inositol likely arises from its interaction with protofibrillar-like aggregates. In Chapter 5, the final chapter which examines the binding mechanism of inositol, I proceeded to characterize the binding mechanism of inositol with protofibrils of A$\beta$42.  

% This is a more of a perspective sentence which links my last results chapter with the rest of my thesis.
From the inositol results, I found that the binding modes of inositol with KLVFFAE adopt characteristic protein-carbohydrate binding modes.  Thus, an important thing to come out of all my work is that the approach taken in all three of my studies on inositol may be useful for the investigation of protein-carbohydrate binding in general. 
% Is there anything else?

In Chapter 6, applying the general methodology developed in this thesis, I characterize the binding modes and sites of monosaccharrides glucosamine and GlcNac with  PgaB, a key protein responsible for the export of polysaccharrides important for the formation of biofilms.  Using conventional sampling methods, I was able to map out a binding surface which predicts a possible binding mode for the biologically relevant polymer substrate, which has been elusive to crystallize. The study presented in this chapter demonstrates that the methodology I have developed and utilized throughout the thesis may be successfully applied and adapted to characterize other carbohydrate-binding proteins.  %  Some where in here, maybe mention weak binding and how this relates to why I was able to use this methodology?
