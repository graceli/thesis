...
A polyphenol molecule, morin, with the ability to inhibit amyloid formation of A$\beta$ and IAPP peptides \textit{in vitro},\cite{Hamaguchi:2009p2874}\cite{Noor:2012fc} was investigated with protofibrils of \abeta42\ using MD simulations by Lemkul et. al.\cite{Lemkul:2010bf} Based on contact analysis and snapshots from their simulations, morin was found to bind, predominantly, at the edges of the protofibril and to penetrate, partially, into the hydrophobic interior of the protofibril.  Furthermore, morin molecules was observed to hydrogen-bond to and intercalate between a pair of residues which formed salt-bridges within the fibril in a significant fraction of their simulations.
...
In a follow-up MD study, the same authors investigated the effect of morin binding on the aggregation and conformational equilibria of monomers and dimers of \abeta42.\cite{Lemkul:2012jn} Morin was not observed to significantly bind to the central hydrophobic core of the Abeta peptide (residues 16 to 21), but instead, to the residues flanking it.  Morin-peptide interactions were found to  impede the formation of intra- and inter-peptide hydrophobic contacts, but did not affect the secondary structure of the peptide.   On the basis of these results, the authors proposed that morin prevents fibril formation of \abeta42\ by preventing and disrupting the hydrophobic association to form an initial aggregation nuclei.

Mon-steroidal anti-inflammatory drugs (NSAIDs), which are typically administered for pain relief, are also found to inhibit Abeta fibrils \textit{in vitro}.\cite{Agdeppa:2003us,Hirohata:2005kc}  In a series of MD simulation studies, Klimov et. al. examined the binding mechanism of ibuprofen\cite{Raman:2009jn} and naproxen\cite{Kim:2011fn} with oligomers and protofibrils of \abeta40.
...
In their ibuprofen study, the authors found that ibuprofen preferentially binds with the protofibril rather than monomeric peptide of \abeta40.\cite{Raman:2009jn} Ibuprofen predominantly bound in hydrophobic grooves at the edges of protofibrils. The authors proposed that this protofibrillar binding mode of NSAIDs may inhibit fibril formation by blocking fibril elongation.  Furthermore, a comparative study of naproxen and ibuprofen were carried out to identify the molecular basis of naproxen's stronger \textit{in vitro} binding affinity.\cite{Takeda:2010gx} Although both NSAID molecules share binding sites on the fibril, naproxen was found to have higher binding energy than ibuprofen because of its preference for self-interaction. 
...
An implicit solvation model may be used in place of explicit solvent representation in order to reduce computational complexity of the simulations.\cite{Feig:2004jd} Some of the studies above have utilized this method to examine small molecule binding mechanisms.\cite{Kim:2011fn,Takeda:2010gx,Raman:2009jn} However, one key disadvantage of implicit solvation is that the reproduction of solvent effects is much less accurate. Because solvent effects are an important contributing factor to the free energy of ligand binding,  poor reproduction of these effects can lead to quantitative errors in binding mode predictions.
% Nevertheless, the authros derived interesting results which may help further our understanding of small molecule binding...

Few studies conducted currently are systematic comparative studies of monomers, disordered oligomers and protofibrillar aggregates. Because it is often not known which amyloidogenic species these small molecules may act on, the lack of adequate comparisons may leave a study susceptible to biased mechanistic hypotheses. Moreover, experimental studies have suggested that the activity of these small molecules may be modulated by their concentration and molar ratio. For example, the self-aggregation of small-molecule binders such as EGCG and CR, has been reported in both experimental\cite{Feng:2008fj,Maltsev:2012kw,Lendel:2010p3376} and simulation studies.\cite{Liu:2011ka,Takeda:2010gx,Raman:2009jn} However,  the mechanistic link of this effect to their mechanism of amyloid inhibition has not been addressed by most studies.

% Many studies do not address reversible binding.
Amyloidogenic monomers and oligomers are highly dynamic species, and may require a large amount of computational sampling in order to obtain statistical convergence in their secondary structures in order to determine the effect of presence of small molecules on their conformational equilibria. Hence, several MD studies have utilized smaller fragments of the A$\beta$ peptide.\cite{Convertino:2011epa,Convertino:2009ce,Chebaro:2012ba} Recent studies have begun to perform MD simulations in combination with enhanced sampling methods to probe binding of small molecules with full-length peptide monomer of A$\beta$.  However, many existing studies in literature, particularly those which probe the effect of ligand binding on conformation of monomers and oligomers of the full-length A$\beta$ peptides, draw conclusions based on results that is likely to be unconverged in the conformational property of interest.  Due to the lack of assessment of convergence in these simulations, researchers have been unable to assess the statistical significance of their data, which could lead to conclusions based on data with significant systematic biases. 
