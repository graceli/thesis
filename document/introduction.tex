...
% Why should we care about protein folding ??? XXX

The seminal experiment by afinsen led to explosion of discoveries in structural biology - that is  centered importance on protein structure discovery, and having the structure of protein, we are able to deduce function, which enabled us to uncover how life works at the molecular level.
Give some specific examples of what proteins are involved in biology to bulk it up - signal transduction, cell cycle regulation, XXX what else?

Not surprisingly, the break down of normal protein function leads to disease.

% Stolen and butchered from Sarah's thesis
For many years, structural biologists focused their studies on proteins with well-defined folded states, and proteins without a unique folded state were largely sidelined.
...
Inhibitors of enzymes bind typically in the nanomolar range (???).  For example, XXX
...
% How does this section fit?  Not sure, but has to be here.
