...
\begin{figure}
 ...
 \caption[Characteristic cross-$\beta$ spacings from X-ray fibre diffraction studies of amyloid fibrils]{A Example EM images of oligomers. Adapted from Bitan G. et al. 2003 and Walsh D. 1999 C TEM image of fibrils D SSNMR model proposed by Tycko et al. I NEED TO ADD the fibril axes.}
...
% Masters CL, Simms G, Weinman NA, Multhaup G, McDonald BL, Beyreuther K. Amyloid plaque core protein in Alzheimer disease and Down syndrome. Proc Natl Acad Sci USA 1985; 82: 4245Ð49.
% Gandy S. The role of cerebral amyloid beta accumulation in common forms of Alzheimer disease. J Clin Invest 2005; 115: 1121Ð29.
...
% Jarrett JT, Berger EP, Lansbury PT Jr. The carboxy terminus of the beta amyloid protein is critical for the seeding of amyloid formation: implications for the pathogenesis of AlzheimerÕs disease. Biochemistry 1993; 32: 4693Ð97. 
% Walsh DM, Selkoe DJ. Deciphering the molecular basis of memory failure in AlzheimerÕs disease. Neuron 2004; 44: 181Ð93.
...
\abeta\ aggregates have been found to be present in a variety of morphologies in the brain. Although plaques are often visible in the dementia patients, the plaque load does not correlate with disease progression and severity, a puzzling aspect of AD. Instead, synaptic loss, and severity of cognitive impairment correlated well with the concentration of soluble \abeta\ oligomers in the brain. (Lue et al. 1999; McLean et al. 1999; Wang et al. 1999)

Upon the addition of A$\beta$ oligomers (prepared in vitro or extracted from cell cultures), cellullar models of toxicity showed characteristic symptoms of neurotoxicity, leading to eventual apoptosis.\cite{Cappai:2007bc,Lambert:1998ve,Walsh:2002p2566,Shankar:2008bg,Walsh:2007fu} Moreover, injection of certain forms of A? oligomers into brains of rats\cite{Lesne:2006gx,Cleary:2005kt} and mice\cite{Martins:2007bz} have been shown to induce neuronal deficits.
...
% When Ab is deposited and aggregated in a nonÐb sheet (nonfibrillar) conformation, it is detected via immunohisto- chemical techniques as ÒdiffuseÓ plaques (Fig. 1C). REF
Taken together, current experimental evidence indicates that preventing the formation of these toxic oligomeric forms of A$\beta$ may be a viable method of treatment for AD.
...
% \cite{Mangialasche, F. M., Solomon, A., Winblad, B., Mecocci, P., and Kivipelto, M. (2010) Alzheimerâ€™s disease: clinical trials and drug devleopmentâ€™. Lancet Neurol. 9, 702â716.} \cite{(4) The 2012 PhRMA Report on Medicines in Development: Alzheimerâ€™s disease. See www.phrma.org.} 

% PhRMA reports in their 2012 Medicines in Development Report for AD4 that there are currently 93 medicines in various stages of development, both small molecule and biologic. In general, all 93 compounds fall into one of the following therapeutic strategies: (1) agents targeting neurotransmission, (2) agents targeting AÎ² production, (3) agents targeting AÎ² aggregation, (4) agents targeting AÎ² clearance, (5) agents increasing brain resistance to AÎ², (6) agents targeting tau protein, and (7) agents targeting neurotrophins and agents modulating synaptic plasticity and nerve growth.1âˆ’4 \cite{From the ACS neurochem's editorial letter}

% (1) Data from the Alzheimerâ€™s association. See www.alz.org.
% (2) Data from Alzheimerâ€™s foundation. See www.alzfdn.org.
% (3) Mangialasche, F. M., Solomon, A., Winblad, B., Mecocci, P., and Kivipelto, M. (2010) Alzheimerâ€™s disease: clinical trials and drug devleopmentâ€™. Lancet Neurol. 9, 702âˆ’716. Special Issue: Alzheimer's Disease Published: November 21, 2012
% (4) The 2012 PhRMA Report on Medicines in Development: Alzheimerâ€™s disease. See www.phrma.org. -- I should have a look at this report
% (5) Sadeghi-Nejad, N. (2012) The Lessons of failure: what we can learn from bapineuzumabâ€™s blowup. Forbes (Pharma & Healthcare), August 7, 2012.
...
Polyphenols is a class of molecules found naturally in plants composed of one or more aromatic phenolic rings, with multiple hydroxyls around these rings.
In particular, the most common subgroup of phenolic compounds are called flavonoids (Figure~\ref{fig:polyphenols})\textbf{Are these molecules flavonoids?}, which are known for their anti-oxidant properties. Experimental studies of several flavonoids have suggested that they may modulate amyloid aggregation. Furthermore, because of their favorable toxicity profiles and high IC50 of inhibition, they have emerged as promising therapeutic candidates for Alzheimer's Disease and related neurodegenerative diseases.

Among the most well-studied compound for its anti-amyloidogenic properties is -epigallocatechin-3-gallate (EGCG), the major polyphenolic component of green tea. In vitro, EGCG molecules may promote self-assembly of amyloidogenic peptides \abeta\cite{Ehrnhoefer:2008fd} and \alphas\cite{Bieschke:2010ju} into ``off pathway'' oligomers and inhibit the formation of mature fibrils by directly binding to monomeric forms of these peptides. Furthermore, in vitro cell culture experiments indicate that micromolar concentrations of EGCG are protective against A$\beta$-induced cell death. [Bastianetto et al., 2006; Kim et al., 2007; Levites et al., 2003]. \cite{Porat:2006fn} 

Curcumin, is the main constituent of the spice turmeric, has been found to inhibit fibril formation and extension, and destabilize preformed fibrils in vitro at nanomolar concentrations.\cite{Singh:2012df} (Ono et al., 2004; Kim et al., 2005) 

Resveratrol, a polyphenolic molecule found in grapes, red wine and berries, have been found to inhibit the fibril formation of both the amyloid-$\beta$ and the islet amyloid polypeptide.\cite{Ono:2008bl,Feng:2009km}
...
Although both in vitro and mouse studies of these polyphenolic compounds suggest that they have therapeutic potential, their molecular mechanism of action is currently not yet understood. Find a drug that is amenable to administer orally as it is one of the easier methods to deliver a drug into a patient. Studies have suggested that polyphenols are able to permeate across the BBB. However, because of their antioxidant properties, polyphenols possess poor bioavailability when administered orally.\cite{Baur:2006bx,Smith:2011iq} Currently, no known clinical trials in AD for curcumin, resveratrol and green tea catechins have been completed. 
\textbf{Their pharmacological properties ... toxicity ... }
\textbf{What other diseases can they treat?}
\textbf{Has there been any trials using them? Good to indicate here.}

%19. Porat Y, Abramowitz A, Gazit E (2006) Inhibition of amyloid fibril formation by polyphenols: Structural similarity and aromatic interactions as a common inhibition mechanism. Chem Biol Drug Des 67(1):27Ð37.
%20. Ehrnhoefer DE, et al. (2008) EGCG redirects amyloidogenic polypeptides into un- structured, off-pathway oligomers. Nat Struct Mol Biol 15(6):558Ð566.
%21. Bieschke J, et al. (2010) EGCG remodels mature ?-synuclein and amyloid-? fibrils and reduces cellular toxicity. Proc Natl Acad Sci USA 107(17):7710Ð7715.
%22. Ladiwala ARA, Dordick JS, Tessier PM (2011) Aromatic small molecules remodel toxic soluble oligomers of amyloid ? through three independent pathways. J Biol Chem 286(5):3209Ð3218.
%23. Lemkul JA, Bevan DR (2012) Morin inhibits the early stages of amyloid ?-peptide aggregation by altering tertiary and quaternary interactions to produce Òoff-pathwayÓ structures. Biochemistry 51(30):5990Ð6009.
%24. Sinha S, et al. (2012) Comparison of three amyloid assembly inhibitors: The sugar scyllo-inositol, the polyphenol epigallocatechin gallate, and the molecular tweezer CLR01. ACS Chem Neurosci 3(6):451Ð458.
%25. Lopez del Amo JM, et al. (2012) Structural properties of EGCG-induced, nontoxic AlzheimerÕs disease A? oligomers. J Mol Biol 421(4-5):517Ð524.
%26. DeToma AS, Choi J-S, Braymer JJ, Lim MH (2011) Myricetin: A naturally occurring regulator of metal-induced amyloid-? aggregation and neurotoxicity. ChemBioChem 12(8):1198Ð1201.
...
% The structureâ€“activity relationship (SAR) is the relationship between the chemical or 3D structure of a molecule and its biological activity. 
...
% This is a potentially relevant side idea which came out of my readings that I can weave into the conclusion. Copeland et. al. argues that residence time is more indicative of drug efficacy in vivo â€¦ (but I fail to grasp how a drug can have the same Kd but different dissociation rates. So for example if a drug comes off and goes on fairly fast, doesnâ€™t that also imply that the drug is also bound for a relatively short amount of time? Or perhaps my understanding of binding rates is flawed.) copeland says that measuring the residence time is important because it is independent of whether the protein-ligand binding studies are done in a closed (like in vitro systems) or open (where the target and ligand concentrations are in dynamic flux -- and so Kd may not be an appropriate measure of efficacy). \cite{Tummino:2008bd,Copeland:2011dl,Copeland:2006bb}

% [More for the conclusions] Here I can link this to MD .. in MD we can calculate the drug residence times as well to get an idea of how long the receptor-ligand complex may last. It is likely that this may be an important property for amyloid inhibition as well â€¦ what should be the rest of this logic? I think the connection for me here ends at the fact that we can also estimate residence lifetimes from simulation data: Modelling and simulations is a promising approach for drug design because of the wealth of data available from just a single atomistic simulation trajectory. For example, one can easily determine X, Y, Z â€¦ and in vivo drug residence lifetime is one such property that is useful to predict
...
% comprehensive study of AÎ²-small molecule interactions is lacking. Traditional MD simulations
...
% REMD. Such a combined approach, employing a diverse set of AÎ² structures as targets for
...
% REF: Liu, F.-F., Ji, L., Dong, X.-Y., and Sun, Y. (2009) Molecular insight into the inhibition effect of trehalose on the nucleation and elongation of amyloid ˆ-peptide oligomers. J. Phys. Chem. B 113, 11320!11329
...
% Gaps ... However, there are a number of issues with the current studies. Studies are not comparative. Some studies use implicit solvent only.  Each of the studies reviewed above use a different force field. Concentration dependence rarely looked at. High concentrations were used for both peptides and ligands. All studies seem to ÒconfirmÓ the in vitro studies for the ligand of interest.
...
% And then say bam our study is complete É  we need to be as complete as possible for our study. 
...
%Following the approach of studying systems of increasing complexity, we have chosen the following peptides and sequences: (1) Alanine Dipeptide; (2) (GA)4; (3) KLVFFAE; (4) SNNFGAIL; (5) AÎ²40/42. Amyloid-forming proteins involved in disease, such as AÎ², Tau (Alzheimer's) or hIAPP (diabetes), are often many residues in length and high in sequence complexity, which renders the collection of meaningful statistics from large-scale computer simulations of these protein aggregates difficult. However, many of these longer sequences have been found to have shorter segments that preserve the amyloidogenicity and cytotoxicity of the longer parent protein.30, 31 These shorter peptides not only have been shown to retain the physiochemical properties for studying general mechanisms of amyloid formation experimentally, but also are much simpler systems suitable for detailed computational studies.
%
%4.4	Alanine Dipeptide
%	Alanine dipeptide (N-acetyl-L-alanine-N'-methylamide or AcAlaNHMe) is a minimalist model of the peptidic backbone with its two backbone dihedral angles (Ï†,Ïˆ) as its significant degrees of freedom. The dominant conformations of its conformational equilibrium span all possible dihedral angles representative of Î±-helices and Î²-sheets in (Figure 1A). Due to the simplicity of alanine dipeptide, all relevant local peptidic backbone binding modes of inositol can be explored efficiently computationally.
%
%4.5	GAGAGAGA
%	An octamer with repetitive sequence involving only nonpolar side-chains, (GA)4 is the simplest amyloidogenic peptide32 of relevance to study the interaction of inositol with the peptidic backbone. GA is a commonly occurring sequence motif in the Î²-sheet forming (crystalline) domains of a variety of spider silks.33 The tetramer GAGA is a part of the B. Mori silk fibroin, which is found to contain Î²-sheet structure.34 The repetitive nature of (GA)4 and its low sequence complexity allow simulations to be computational tractable and thus, permits timescales needed to determine the effects of inositol on amyloid aggregation in a statistically meaningful way. Finally, the simplicity of (GA)4 allows the detailed examination and dissection of the different possible types of inositol-peptide interactions. 

%4.6	KLVFFAE
%	The peptide KLVFFAE, a segment spanning residues 16 to 22 of AÎ²1-40 and AÎ²1-42, has been well studied both experimentally and computationally.35-38 KLVFFAE is the central hydrophobic core thought to be important in full-length AÎ² assembly and is affected by four AD causing mutations: A31G (Flemish), E22Q (Dutch), E22K (Italian), and E22G (Arctic). This peptide not only contains side chains with more bulk, but also those capable of forming charged and aromatic interactions. The protofibrillar structure has been shown by SSNMR to have anti-parallel Î²-sheet organization with possible parallel stacking of the Î²-sheets.36 

% 4.7	SNNFGAIL
%	hIAPP(20â€“27) (SNNFGAIL) is an octameric segment of the 37-amino acid residue hIAPP polypeptide and is both amyloidogenic and cytotoxic.39 Pancreatic amyloid in humans forms through the aggregation of islet amyloid polypeptide (hIAPP). hIAPP-derived amyloid is found in more than 95% of type II diabetes patients and is believed to be directly involved in the pathogenesis of the disease. The peptide SNNFGAIL is different from KLVFFAE in that it is an amphipathic peptide where SNN is polar and FGAIL is nonpolar.39 Thus, the protofibrillar structure formed will likely have different surface properties despite sharing similar backbone secondary structure.

%4.8	Full length AÎ²40 or AÎ²42
%	Inositol does not necessarily act on the shorter peptide models and their aggregates. To address this possibility, I will study inositol with the AÎ² peptide and aggregates. The monomeric, oligomeric, and fibrillar structures of AÎ²40 and AÎ²42 have been studied both experimentally and computationally.4, 16, 40-45 Thus, I will utilize the structural data available to construct oligomeric and fibrillar species and comparatively analyze the interaction of chiro- and scyllo-inositol with these species.