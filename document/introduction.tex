...
Binding modes of  morin, a polyphenol molecule with the ability to inhibit amyloid formation of A$\beta$ and IAPP peptides \textit{in vitro},\cite{Hamaguchi:2009p2874}\cite{Noor:2012fc} were investigated with protofibrils of \abeta42\ using MD simulations by Lemkul et. al.\cite{Lemkul:2010bf} Based on contact analysis and snapshots from their simulations, morin predominantly bound at the edges of the protofibril, and partially penetrated the hydrophobic interior of the protofibril.  Furthermore, in a significant fraction of their simulations, morin molecules hydrogen-bonded to and intercalated between a pair of residues which formed salt bridges within the fibril.
...
Mon-steroidal anti-inflammatory drugs (NSAIDs), which are typically administered for pain relief, are also found to inhibit Abeta fibrils \textit{in vitro}.\cite{Agdeppa:2003us,Hirohata:2005kc}  In a series of MD simulation studies, Klimov et. al. examined the binding mechanism of ibuprofen\cite{Raman:2009jn} and naproxen\cite{Kim:2011fn} with monomers, oligomers and protofibrils of \abeta40.
...
An implicit solvation model may be used in place of explicit solvent representation in order to reduce computational complexity of the simulations.\cite{Feig:2004jd} Some of the studies above have employed this methodology to examine small molecule binding mechanisms.\cite{Kim:2011fn,Takeda:2010gx,Raman:2009jn} However, the key disadvantage of implicit solvation is the lack of solvent effects, which is an important contributor to the free energy of ligand binding, thus may lead to quantitative errors in binding mode predictions. Certain models of solvation introduce approximations to account for these effects, but are much less accurate in reproducing them.  % Nevertheless, the authros derived interesting results which may help further our understanding of small molecule binding...
...
However, many existing studies in literature, particularly those which probe the effect of ligand binding on conformation of monomers and oligomers of the full-length A$\beta$ peptides, draw conclusions based on non-equilibrium simulations that is likely to be unconverged in the conformational property of interest.\cite{Liu:2011ka,Convertino:2009ce,Lemkul:2012jn}  Due to the lack of assessment of convergence in these simulations, researchers have been unable to assess the statistical significance of their data, which could lead to conclusions based on data with significant systematic biases. 
